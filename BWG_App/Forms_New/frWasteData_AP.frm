...
Begin VB.Form frWasteData_bak080630 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Begin WasteManagment.ctlGrid grParameter 
         Height          =   2535
         Left            =   -74880
         TabIndex        =   109
         Top             =   840
      ...
      Begin VB.ComboBox cboWasteCharDesc 
         Height          =   315
         ItemData        =   "frWasteData_AP.frx":0171
         Left            =   2310
         List            =   "frWasteData_AP.frx":017E
         Style           =   2  'Dropdown List
         TabIndex        =   26
         Top             =   450
         Width           =   1695
      ...
      Begin VB.ComboBox cboWasteChar 
         Height          =   315
         ItemData        =   "frWasteData_AP.frx":0197
         Left            =   330
         List            =   "frWasteData_AP.frx":01A7
         Style           =   2  'Dropdown List
         TabIndex        =   25
         Top             =   450
         Width           =   1905
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cboTimeRate 
         Height          =   315
         ItemData        =   "frWasteData_AP.frx":01D3
         Left            =   10290
         List            =   "frWasteData_AP.frx":01DD
         Style           =   2  'Dropdown List
         TabIndex        =   22
         Top             =   300
         Width           =   795
      ...
      Begin VB.ComboBox cboUnitRate 
         Height          =   315
         ItemData        =   "frWasteData_AP.frx":01EC
         Left            =   9360
         List            =   "frWasteData_AP.frx":01F6
         Style           =   2  'Dropdown List
         TabIndex        =   21
         Top             =   300
         Width           =   735
      ...
      Begin VB.ComboBox cboMaxUnit 
         Height          =   315
         ItemData        =   "frWasteData_AP.frx":0205
         Left            =   5940
         List            =   "frWasteData_AP.frx":020F
         Style           =   2  'Dropdown List
         TabIndex        =   19
         Top             =   300
         Width           =   735
      ...
      Begin VB.ComboBox cboQtyUnit 
         Height          =   315
         ItemData        =   "frWasteData_AP.frx":021E
         Left            =   2700
         List            =   "frWasteData_AP.frx":0228
         Style           =   2  'Dropdown List
         TabIndex        =   17
         Top             =   300
         Width           =   735
   ...
   End
End
Attribute VB_Name = "frWasteData_bak080630"
...
Private Sub cmdApprove_Click()
    If MsgBox("ท่านต้องการตรวจรับของเสียรายการนี้หรือไม่?", vbQuestion + vbYesNo) = vbYes Then
        If isSave = False Then
            MsgBox "รายละเอียดไม่ครบ ไม่สามารถตรวจรับได้", vbInformation, "Warning"
            Exit Sub
        End If
...
Dim i As Integer
    ...
    If Trim(txtQty.Text) = "" Then
        MsgBox "กรุณาระบุปริมาณที่จัดเก็บปัจจบัน", vbExclamation
        txtQty.SetFocus
        isSave = False
        Exit Sub
    End If
    If Trim(txtRate.Text) = "" Then
        MsgBox "กรุณาระบุอัตราการเกิดของเสีย", vbExclamation
        txtRate.SetFocus
        isSave = False
        Exit Sub
    End If
    ...
    If cboIndoor.ListIndex = 0 Then
        ...
        Exit Sub
    End If
    If chkBag.Value = 0 And chkYard.Value = 0 And chkDrum.Value = 0 And chkOther2.Value = 0 And chkTank.Value = 0 Then
...
Private Sub ctlDate1_Validate(Cancel As Boolean)
    myWasteDataCR_.AnalyseDate = ctlDate1.ValueYMD
...
Private Sub txtContractNo_Validate(Cancel As Boolean)
    ...
    Else
        If Trim(myWasteDataCR_.Contract.docNo) <> Trim(txtContractNo.Text) Then
            Set myWasteDataCR_.Contract = New BWGContract
            Load frContractSearch
            With frContractSearch
    ...
    Else
        If Trim(curEUCode1_.Code1) <> Trim(txtEUCode1.Text) Then
            ...
            With myWasteDataCR_
                ...
                .EUCode1 = ""
            End With
            Load frEUCode1Search
            With frEUCode1Search
    ...
    Else
        If Trim(curEUCode2_.Code2) <> Trim(txtEUCode2.Text) Then
            ...
            With myWasteDataCR_
                ...
                .EUCode2ID = ""
            End With
            Load frEUCode2Search
            With frEUCode2Search
    ...
    Else
        If Trim(curEUCode3_.Code3) <> Trim(txtEUCode3.Text) Then
            ...
            With myWasteDataCR_
                ...
                .EUCode3ID = ""
            End With
            Load frEUCode3Search
            With frEUCode3Search
...
Dim selResult As Integer
    If cmdSave.Enabled = False Then myWasteDataCR_.isChanged = False: myWasteDataLab_.isChanged = False
...
'        End If
        ...
        ctlDate1.ValueDMY = IIf(IsDate(.AnalyseDate), Format(.AnalyseDate, "dd/mm/yyyy"), Format(TodayDate, "dd/mm/yyyy"))
