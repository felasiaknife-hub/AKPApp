...
Begin VB.Form frmQuotation 
   ...
   Begin TabDlg.SSTab SSTabQuo 
      ...
      Tab(2).Control(0)=   "CmdSelTruck"
      Tab(2).Control(1)=   "GrCar"
      Tab(2).Control(2)=   "cboIsTrailer3"
      Tab(2).Control(3)=   "cboTransUnit3"
      Tab(2).Control(4)=   "txtTransRate3"
      Tab(2).Control(5)=   "txtCarType3"
      Tab(2).Control(6)=   "cboIsTrailer4"
      Tab(2).Control(7)=   "cboTransUnit4"
      Tab(2).Control(8)=   "txtTransRate4"
      Tab(2).Control(9)=   "txtCarType4"
      Tab(2).Control(10)=   "cboIsTrailer2"
      Tab(2).Control(11)=   "cboTransUnit2"
      Tab(2).Control(12)=   "txtTransRate2"
      Tab(2).Control(13)=   "txtCarType2"
      Tab(2).Control(14)=   "cboIsTrailer5"
      Tab(2).Control(15)=   "cboTransUnit5"
      Tab(2).Control(16)=   "txtTransRate5"
      Tab(2).Control(17)=   "txtCarType5"
      Tab(2).Control(18)=   "cboIsTrailer6"
      Tab(2).Control(19)=   "cboTransUnit6"
      Tab(2).Control(20)=   "txtTransRate6"
      Tab(2).Control(21)=   "txtCarType6"
      Tab(2).Control(22)=   "cboIsTrailer7"
      Tab(2).Control(23)=   "cboTransUnit7"
      Tab(2).Control(24)=   "txtTransRate7"
      Tab(2).Control(25)=   "txtCarType7"
      Tab(2).Control(26)=   "cboIsTrailer8"
      Tab(2).Control(27)=   "cboTransUnit8"
      Tab(2).Control(28)=   "txtTransRate8"
      Tab(2).Control(29)=   "txtCarType8"
      Tab(2).Control(30)=   "txtCarType9"
      Tab(2).Control(31)=   "txtTransRate9"
      Tab(2).Control(32)=   "cboTransUnit9"
      Tab(2).Control(33)=   "cboIsTrailer9"
      Tab(2).Control(34)=   "Label2(44)"
      Tab(2).Control(35)=   "Label2(32)"
      Tab(2).Control(36)=   "Label2(33)"
      Tab(2).Control(37)=   "Label2(38)"
      Tab(2).Control(38)=   "Label2(39)"
      Tab(2).Control(39)=   "Label2(40)"
      Tab(2).Control(40)=   "Label2(41)"
      Tab(2).Control(41)=   "Label2(42)"
      Tab(2).Control(42)=   "Label2(43)"
      Tab(2).Control(43)=   "Label2(45)"
      Tab(2).Control(44)=   "Label2(46)"
      Tab(2).Control(45)=   "Label2(47)"
      Tab(2).Control(46)=   "Label2(48)"
      Tab(2).Control(47)=   "Label2(49)"
      Tab(2).Control(48)=   "Label2(50)"
      Tab(2).Control(49)=   "Label2(51)"
...
Sub SaveselTtruck()
        ...
        Dim tmpRec As ADODB.Recordset
            With GrCar
                ...
                For i = 1 To r - 1
                Set tmpRec = New ADODB.Recordset
                Tt = Replace(.getGridObj.TextMatrix(i, 0), "'", "")
                ...
                Set tmpRec = GetRS(sqlSel, adOpenForwardOnly, adLockReadOnly)
                    If tmpRec.EOF = False Then
                        tSql = "update tbSelTruck set TrailerType='" & .getGridObj.TextMatrix(i, 2) & "',TransportFee=" & Val(.getGridObj.TextMatrix(i, 3)) & ",MinWeight=" & Val(.getGridObj.TextMatrix(i, 4)) & "" & vbCrLf
                    ...
                    Else
                        ...
                        tSql = tSql & "VALUES ('" & GetGUID & "','" & myQuotation_.ID & "', " & .getGridObj.TextMatrix(i, 0) & ",'" & .getGridObj.TextMatrix(i, 2) & "'," & Val(.getGridObj.TextMatrix(i, 3)) & "," & Val(.getGridObj.TextMatrix(i, 4)) & ")" & vbCrLf
                        DBConnExc tSql
                    End If
                Next i
            End With
