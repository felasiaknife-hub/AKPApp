...
Begin VB.Form FrmPrintFIN15B 
   ...
   Begin VB.Label Label2 
      BackColor       =   &H00FF8080&
      Caption         =   "รายงานค่ากำจัด FIN15_B"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   9.75
         Charset         =   222
   ...
   Begin VB.Image Image2 
      ...
      Index           =   1
      Left            =   0
      Picture         =   "FrmPrintFIN15B.frx":0000
      Stretch         =   -1  'True
      Top             =   0
      Width           =   11280
   End
End
Attribute VB_Name = "FrmPrintFIN15B"
...
'    End If
        .LogonInfo(0) = "DSN = " & DSN_NAME & ";UID = " & strUid & ";PWD = " & strPwd
        .ReportFileName = App.Path & "\reports\FIN15B.rpt"
        tmpSql = ""
        tmpSql = "SELECT * FROM vw_RptFIN15B" & vbCrLf
        ...
        If cboCustType.ListCount > 1 Then
            If cboCustType.ListIndex = 1 Then
                tmpSql = tmpSql & " AND CustomerType in ('A') "
            ElseIf cboCustType.ListIndex = 2 Then
                tmpSql = tmpSql & " AND CustomerType in ('B') "
            ElseIf cboCustType.ListIndex = 3 Then
                tmpSql = tmpSql & " AND CustomerType in ('C') "
            End If
        End If
        ...
        If Not curCustomer_ Is Nothing Then
            ...
            End If
        End If
         tmpSql = tmpSql & vbCrLf & " ORDER BY WorkDate,Customercode"
        .SQLQuery = tmpSql
