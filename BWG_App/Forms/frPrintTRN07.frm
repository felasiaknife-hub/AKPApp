...
Begin VB.Form frmPrintTRN07 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cboJobStatus 
         Height          =   315
         ItemData        =   "frPrintTRN07.frx":0000
         Left            =   1140
         List            =   "frPrintTRN07.frx":0002
   ...
   Begin VB.Image Image2 
      ...
      Index           =   1
      Left            =   0
      Picture         =   "frPrintTRN07.frx":0004
      Stretch         =   -1  'True
      Top             =   0
      Width           =   11280
   End
End
Attribute VB_Name = "frmPrintTRN07"
...
Dim tmpSql As String, subStr As String
    With rpt1
        ...
        .ReportFileName = App.Path & "\reports\TRN07.rpt"
        tmpSql = ""
        tmpSql = "Select  *  FROM vw_RptTRN07" & vbCrLf
