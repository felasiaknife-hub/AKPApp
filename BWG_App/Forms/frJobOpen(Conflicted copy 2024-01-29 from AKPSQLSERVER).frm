...
Begin VB.Form frmJobOpen 
   ...
   Begin VB.Frame Frame7 
      ...
      Begin VB.Label Label25 
         BackColor       =   &H00C0C0FF&
         Caption         =   "ถังพลาสติก 200 ลิตรปากจู๋"
         Height          =   255
         Left            =   2200
         TabIndex        =   120
         Top             =   2475
...
End If
    ...
    For x = 1 To myJobOpen_.Cars.Count
        If myJobOpen_.Cars(x).isTrailer And myJobOpen_.Cars(x).TruckCount Mod 2 <> 0 Then
            ...
            Exit Sub
        ElseIf myJobOpen_.Cars(x).GoSameTime = "" Then
        ...
        Set RSVisit = GetRS(sqlVisit, adOpenForwardOnly, adLockOptimistic)
            ...
            Dim VisID, Tp, VT, Fp As String
                ...
                VisID = GetGUID
                    ...
                    Else
                        DBConnExc "Insert into tbCustomerVisitHeader(VisitID,Companyname, CustomerID, VisitDate,VisitType,VisitTime,FullPoint) Values ('" & VisID & "','" & Trim(txtCustomer.Text) & "','" & myJobOpen_.CustomerID & "','" & myJobOpen_.WorkDate & "','" & Tp & "','" & VT & "','" & Fp & "')"
                    End If
            End If
