...
Begin VB.Form frmPrintTRN06 
   ...
   Begin VB.Label Label1 
      AutoSize        =   -1  'True
      BackStyle       =   0  'Transparent
      Caption         =   "พิมพ์รายงานปริมาณกากของเสียประเภท Haz. (TRN06)"
      BeginProperty Font 
         Name            =   "Angsana New"
         Size            =   15.75
         Charset         =   222
   ...
   Begin VB.Image Image2 
      ...
      Index           =   1
      Left            =   0
      Picture         =   "frPrintTRN06.frx":0000
      Stretch         =   -1  'True
      Top             =   0
      Width           =   11280
   End
End
Attribute VB_Name = "frmPrintTRN06"
...
'                ' Me.CryReport.ParameterFields(4) = "dtDateReturn; " & varDate & ";Ture"
    ...
    Me.rpt1.ReportFileName = App.Path + "\Reports\TRN06.rpt"
