...
Begin VB.Form frmIncomepst 
   Caption         =   "รายงานยอดขายฐาน (T,K)"
   ClientHeight    =   5040
   ClientLeft      =   60
   ClientTop       =   435
   ClientWidth     =   6150
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cboOper 
         Height          =   315
         ItemData        =   "frmIncomepst.frx":0000
         Left            =   3360
         List            =   "frmIncomepst.frx":0002
         Style           =   2  'Dropdown List
         TabIndex        =   4
         Top             =   1860
         Width           =   1305
      ...
      Begin VB.ComboBox CobJobtype 
         Height          =   315
         ItemData        =   "frmIncomepst.frx":0004
         Left            =   1140
         List            =   "frmIncomepst.frx":0011
         TabIndex        =   1
         Top             =   2640
         Width           =   1995
      End
   ...
   End
End
Attribute VB_Name = "frmIncomepst"
...
'        tmpSql = tmpSql & "From vw_MenifestSearch" & vbCrLf
        ...
        tmpSql = tmpSql & "  AND ZoneName in ('PST01','PST03') " & vbCrLf
