...
Begin VB.Form frmLABResultInt 
   ...
   Begin VB.Label Label1 
      AutoSize        =   -1  'True
      BackStyle       =   0  'Transparent
      Caption         =   "บันทึกผล LAB ของการตรวจสอบภายใน"
      BeginProperty Font 
         Name            =   "Angsana New"
         Size            =   15.75
         Charset         =   222
   ...
   Begin VB.Image Image2 
      Height          =   795
      Left            =   0
      Picture         =   "frLABResultInt.frx":0000
      Stretch         =   -1  'True
      Top             =   0
      Width           =   11655
   End
End
Attribute VB_Name = "frmLABResultInt"
...
Dim tmpDet As BWGLABResultDetail
    ...
    If cboRecType.ListIndex = 2 Then
        ...
        myLabResult_.ReportNo = "Rejected"
        myLabResult_.isCancel = True
    ElseIf cboRecType.ListIndex = 1 Then
...
Private Sub Form_Load()
    ...
    With curCustomer_
        .CustomerCode = "BWG"
        .CustomerName = "บริษัท เบตเตอร์ เวิลด์ กรีน จำกัด (มหาชน)"
        .Address = "140 หมู่ 8"
        .TumbolName = "ห้วยแห้ง"
        .AumphurName = "แก่งคอย"
        ...
        .ZipCode = "18110"
    End With
    SetDataCustomer curCustomer_, False
    With frmPicture
...
Dim tmpWaste As BWGWasteDataCR
    ...
    With myLabResult_
        ...
        'If curWaste_ Is Nothing Then
            Set tmpWaste = New BWGWasteDataCR
            tmpWaste.WasteName = curSampleDet_.SamplePointName
        'End If
        SetDataWasteData tmpWaste, False
        cmdApprove.Enabled = True
