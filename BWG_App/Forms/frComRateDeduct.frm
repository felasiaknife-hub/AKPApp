VERSION 5.00
Begin VB.Form frmComRateDeduct 
   BackColor       =   &H00FFFFFF&
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "อัตราส่วนลดค่าคอมมิชชั่น - F017"
   ClientHeight    =   6555
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   6210
   ...
   End
End
Attribute VB_Name = "frmComRateDeduct"
...
Dim x%
    If isChanged_ Then
        DBConnExc "Delete ComRateDeduct"
...
Private Sub Form_Load()
    ...
    With grComRate.getGridObj
        ...
        .TextMatrix(0, 3) = "อัตราส่วนลดยอดขาย (%)"
    End With
    ShowComRate
End Sub
...
Dim x%, tmpCom As BWGComRateDeduct
    Set colComRate_ = tmpS.ComRateDeductSearch
...
Dim tmpRate As BWGComRateDeduct
    With grComRate.getGridObj
        ...
        Else
            Set tmpRate = New BWGComRateDeduct
            tmpRate.ID = tmpID
