...
Begin VB.Form frmLABUnit 
   ...
   Begin VB.Image Image2 
      Height          =   705
      Left            =   0
      Picture         =   "frLABUnit.frx":0000
      Stretch         =   -1  'True
      Top             =   0
      Width           =   6870
   End
End
Attribute VB_Name = "frmLABUnit"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Dim curUnit_ As BWGLABUnit
...
Dim tmpStr As String
    ...
    If Trim(txtShortName.Text) <> Trim(curUnit_.UnitName) Then
        If Trim(curUnit_.ID) = "" Then
            curUnit_.ID = GetGUID
            DBConnExc "Insert into tbLABUnit (LABUnitID,UnitName) Values ('" & Trim(curUnit_.ID) & "','" & (txtShortName.Text) & "')"
        ...
        Else
            DBConnExc "Update tbLABUnit Set UnitName='" & Trim(txtShortName.Text) & "' WHERE LABUnitID='" & curUnit_.ID & "'"
