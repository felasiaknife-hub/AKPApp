...
Begin VB.Form FrmQuotationListHeader 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.ComboBox cboStatus 
         Height          =   315
         ItemData        =   "FrmQuotationListHeader.frx":0000
         Left            =   180
         List            =   "FrmQuotationListHeader.frx":0002
      ...
      Begin VB.ComboBox cboCompany 
         Height          =   315
         ItemData        =   "FrmQuotationListHeader.frx":0004
         Left            =   180
         List            =   "FrmQuotationListHeader.frx":0006
         Style           =   2  'Dropdown List
         TabIndex        =   1
         Top             =   1560
         Width           =   2325
   ...
   Begin MSComctlLib.ImageList ImgSorted 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmQuotationListHeader.frx":0008
            Key             =   "up"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmQuotationListHeader.frx":05A2
            Key             =   "down"
         EndProperty
      EndProperty
   End
End
Attribute VB_Name = "FrmQuotationListHeader"
...
'    Set tmpColDet = tmpRec!QuotationDetails
    sqlStr = "SELECT * FROM vw_QuotationHeaderSearch" & vbCrLf
    sqlStr = sqlStr & "WHERE " & strCond & vbCrLf
    sqlStr = sqlStr & "ORDER BY  IssueDate, QuotationNo"
    ...
    Set tmpSel = GetRS(sqlSelTruck, adOpenForwardOnly, adLockReadOnly)
        ...
        End If
        Set tmpList = lvResult.ListItems.Add(, "'" & tmpRec!QuotationID & "'", QNo)
        ...
        tmpList.SubItems(7) = tmpRec!StaffCountPerCar
        tmpList.SubItems(8) = tmpRec!MinWeightPerCar
        tmpList.SubItems(9) = tmpRec!NonMinRate
        tmpList.SubItems(10) = tmpRec!MaxWeight
        tmpList.SubItems(11) = tmpRec!MaxRate & " " & tmpRec!MaxRateType
        tmpList.SubItems(12) = tmpRec!BMEQuotation
        If tmpRec!IsPriceIncTransport = "Y" Then
            tmpList.SubItems(13) = "รวมค่าขนส่ง"
        Else
            tmpList.SubItems(13) = "แยกค่าขนส่ง"
        End If
        If tmpRec!isCancel = "Y" Then
            tmpList.SubItems(13) = "ยกเลิก"
            tmpList.ForeColor = vbRed
            ForeColor = vbRed
        ElseIf tmpRec!isClosed = "Y" Then
            tmpList.SubItems(13) = "Closed"
            tmpList.ForeColor = &H40C0&
            ForeColor = vbRed
        ElseIf tmpRec!isApproved = "Y" Then
            tmpList.SubItems(13) = "อนุมัติแล้ว"
            tmpList.ForeColor = &H8000&
            ForeColor = &H8000&
        Else
            tmpList.SubItems(13) = "ยังไม่อนุมัติ"
            tmpList.ForeColor = vbBlack
            ForeColor = vbBlack
        End If
                        
        If tmpRec!isJobs = "N" Then
            tmpList.SubItems(14) = "งาน Routine"
        ElseIf tmpRec!isJobs = "Y" Then
            tmpList.SubItems(14) = "งาน Job"
        End If
