...
Begin VB.Form frmPrintENV02 
   ...
   Begin VB.Label Label1 
      AutoSize        =   -1  'True
      BackStyle       =   0  'Transparent
      Caption         =   "พิมพ์รายงานปริมาณกากอุตสาหกรรมที่รับกำจัด (ENV02)"
      BeginProperty Font 
         Name            =   "Angsana New"
         Size            =   15.75
         Charset         =   222
   ...
   Begin VB.Image Image2 
      ...
      Index           =   1
      Left            =   0
      Picture         =   "frPrintENV02.frx":0000
      Stretch         =   -1  'True
      Top             =   0
      Width           =   11280
   End
End
Attribute VB_Name = "frmPrintENV02"
...
Dim tmpSql As String
        ...
        DBConnExc "update vw_UpdateEUCode set SelEUCode=Code1 +' '+ Code2 +' '+ Code3 WHERE SelEUCode<>Code1 +' '+ Code2 +' '+ Code3"
        DBConnExc "update vw_UpdateTreatment set TreatmentDesc=STreatmentDesc WHERE TreatmentDesc <> STreatmentDesc"

    With rpt1
        .LogonInfo(0) = "DSN = " & DSN_NAME & ";UID = " & strUid & ";PWD = " & strPwd
        .ReportFileName = App.Path & "\reports\ENV02.rpt"
        tmpSql = ""
        tmpSql = "SELECT * FROM vw_RptENV02 " & vbCrLf
        ...
        If cboCompany.ListCount > 1 Then
            If cboCompany.ListIndex > 0 Then
                If CurrentUser.WorkCompanies(cboCompany.ListIndex + cboIndex).CompanyCode = "AKP" Then
                    tmpSql = tmpSql & " AND APManifestNo IS NOT NULL"
                Else
        ...
        tmpSql = tmpSql & vbCrLf & " ORDER BY CustomerName,ProvinceName,WasteName,WasteDataID,TreatmentDesc,TSDFRegisNo"
        .Formulas(0) = "DateRange=" & Chr(34) & "ช่วงวันที่ขน " & dtFrom.ValueDMY & " ถึงวันที่ " & dtTo.ValueDMY & Chr(34)
