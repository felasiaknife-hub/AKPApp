...
Begin VB.Form frmWasteData_Old 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Waste Data - F148"
   ClientHeight    =   8280
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   11280
   ...
   Begin VB.ComboBox cboSummary 
      Height          =   315
      ItemData        =   "frWasteData.frx":0023
      Left            =   8790
      List            =   "frWasteData.frx":0030
      Style           =   2  'Dropdown List
      TabIndex        =   62
      Top             =   6960
      Width           =   2385
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "frWasteData.frx":0061
      ...
      TabPicture(1)   =   "frWasteData.frx":007D
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "cboTreatmentType"
      Tab(1).Control(1)=   "txtOldStorePlace"
      Tab(1).Control(2)=   "chkYard"
      Tab(1).Control(3)=   "chkTank"
      Tab(1).Control(4)=   "txtOther2"
      Tab(1).Control(5)=   "chkOther2"
      Tab(1).Control(6)=   "txtDrumDesc"
      Tab(1).Control(7)=   "chkDrum"
      Tab(1).Control(8)=   "txtBag"
      Tab(1).Control(9)=   "chkBag"
      Tab(1).Control(10)=   "cboIndoor"
      Tab(1).Control(11)=   "cboStoreType"
      Tab(1).Control(12)=   "lvOldTreatment"
      Tab(1).Control(13)=   "lvNewTreatment"
      Tab(1).Control(14)=   "Label2(31)"
      Tab(1).Control(15)=   "Label2(20)"
      Tab(1).Control(16)=   "Label2(19)"
      Tab(1).Control(17)=   "Label2(18)"
      Tab(1).Control(18)=   "Label2(17)"
      Tab(1).ControlCount=   19
      Begin VB.ComboBox cboTreatmentType 
         Height          =   315
         ItemData        =   "frWasteData.frx":0099
         Left            =   -66030
         List            =   "frWasteData.frx":00A3
         Style           =   2  'Dropdown List
         TabIndex        =   49
         Top             =   480
         Width           =   1995
      ...
      Begin VB.ComboBox cboIndoor 
         Height          =   315
         ItemData        =   "frWasteData.frx":00B9
         Left            =   -70440
         List            =   "frWasteData.frx":00C6
         Style           =   2  'Dropdown List
         TabIndex        =   48
         Top             =   480
         Width           =   2985
      ...
      Begin VB.ComboBox cboStoreType 
         Height          =   315
         ItemData        =   "frWasteData.frx":00DD
         Left            =   -74280
         List            =   "frWasteData.frx":00EA
         Style           =   2  'Dropdown List
         TabIndex        =   47
         Top             =   480
         Width           =   2985
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.ComboBox cboToxic 
            Height          =   315
            ItemData        =   "frWasteData.frx":011C
            Left            =   2250
            List            =   "frWasteData.frx":0126
            Style           =   2  'Dropdown List
            TabIndex        =   38
            Top             =   1020
            Width           =   1875
      ...
      Begin VB.ComboBox cboWasteCharDesc 
         Height          =   315
         ItemData        =   "frWasteData.frx":0153
         Left            =   2310
         List            =   "frWasteData.frx":0160
         Style           =   2  'Dropdown List
         TabIndex        =   27
         Top             =   450
         Width           =   1695
      ...
      Begin VB.ComboBox cboWasteChar 
         Height          =   315
         ItemData        =   "frWasteData.frx":0178
         Left            =   330
         List            =   "frWasteData.frx":0188
         Style           =   2  'Dropdown List
         TabIndex        =   26
         Top             =   450
         Width           =   1905
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cboTimeRate 
         Height          =   315
         ItemData        =   "frWasteData.frx":01B6
         Left            =   10290
         List            =   "frWasteData.frx":01C0
         Style           =   2  'Dropdown List
         TabIndex        =   23
         Top             =   300
         Width           =   795
      ...
      Begin VB.ComboBox cboUnitRate 
         Height          =   315
         ItemData        =   "frWasteData.frx":01CF
         Left            =   9360
         List            =   "frWasteData.frx":01D9
         Style           =   2  'Dropdown List
         TabIndex        =   22
         Top             =   300
         Width           =   735
      ...
      Begin VB.ComboBox cboMaxUnit 
         Height          =   315
         ItemData        =   "frWasteData.frx":01E8
         Left            =   5940
         List            =   "frWasteData.frx":01F2
         Style           =   2  'Dropdown List
         TabIndex        =   20
         Top             =   300
         Width           =   735
      ...
      Begin VB.ComboBox cboQtyUnit 
         Height          =   315
         ItemData        =   "frWasteData.frx":0201
         Left            =   2700
         List            =   "frWasteData.frx":020B
         Style           =   2  'Dropdown List
         TabIndex        =   18
         Top             =   300
         Width           =   735
   ...
   Begin VB.ComboBox cboWasteType 
      Height          =   315
      ItemData        =   "frWasteData.frx":021A
      Left            =   7320
      List            =   "frWasteData.frx":021C
      Style           =   2  'Dropdown List
      TabIndex        =   6
      Top             =   420
      Width           =   1005
   ...
   End
End
Attribute VB_Name = "frmWasteData_Old"
...
Dim tmpS As New BWGSearchManager, tmpCol As Collection
    ...
    If MsgBox("ต้องการลบข้อมูลกากของเสียนี้หรือไม่?", vbQuestion + vbYesNo) = vbYes Then
        tmpGUID = GetGUID
'        DBConnExc "Update tbWasteDataLab Set WasteDataID='" & tmpGUID & "' Where WasteDataID='" & myWasteDataCR_.ID & "'"
        ...
        If Trim(tmpStr) = "" Then
            ...
            txtEUCode1.SetFocus
        Else
            DBConnExc "Update tbWasteDataLab Set WasteDataID='" & myWasteDataCR_.ID & "' Where WasteDataID='" & tmpGUID & "'"
...
'        End If
        ...
        If tmpCol.Count > 0 Then SetDataStaff tmpCol(1), False
        If .WasteApproveStatus = "P" Then
            cboSummary.ListIndex = 0
        ElseIf .WasteApproveStatus = "E" Then
            cboSummary.ListIndex = 1
        ElseIf .WasteApproveStatus = "R" Then
