...
Begin VB.Form frmPrintFIN13_A 
   ...
   Begin VB.Image Image2 
      ...
      Index           =   1
      Left            =   0
      Picture         =   "frmPrintFIN13_A.frx":0000
      Stretch         =   -1  'True
      Top             =   0
      Width           =   11280
   End
   ...
   End
End
Attribute VB_Name = "frmPrintFIN13_A"
...
Dim tmpSql As String
    With rpt1
        ...
        .ReportFileName = App.Path & "\reports\FIN13_A.rpt"
        tmpSql = ""
        tmpSql = "SELECT * FROM vw_Inv_RV_RE " & vbCrLf
...
'        tmpSql = tmpSql & "WHERE IssuedDate>='" & dtFrom.ValueYMD & "' And IssuedDate<='" & dtTo.ValueYMD & "'"
        ...
        If OptRE.Value = True Then
            tmpSql = tmpSql & "WHERE REDate >='" & dtFrom.ValueYMD & "' And REDate <='" & dtTo.ValueYMD & "'"
        End If
        ...
        End If
        If OptRE.Value = True Then
            tmpSql = tmpSql & vbCrLf & " ORDER BY RENo"
        End If
        If OptInv.Value = True Then
