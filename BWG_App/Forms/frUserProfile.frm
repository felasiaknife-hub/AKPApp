    ...
    If cboCompany.ListIndex > 0 Then
        If cboCompany.ListCount > 1 Then
            If cboCompany.ListIndex = 0 Then
             myUser_.CompanyID = ""
            Else
            myUser_.CompanyID = CurrentUser.WorkCompanies(cboCompany.ListIndex).ID
            End If
        Else
            myUser_.CompanyID = CurrentUser.WorkCompanies(cboCompany.ListIndex + cboIndex).ID
        End If
    Else
        myUser_.CompanyID = ""
    End If
...
Private Sub PopulateCompanyList()
