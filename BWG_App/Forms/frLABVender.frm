...
Begin VB.Form frmLABVender 
   ...
   Begin VB.Label Label1 
      AutoSize        =   -1  'True
      BackStyle       =   0  'Transparent
      Caption         =   "ข้อมูล Vender ห้อง LAB ภายนอก"
      BeginProperty Font 
         Name            =   "Angsana New"
         Size            =   15.75
         Charset         =   222
   ...
   Begin VB.Image Image2 
      Height          =   795
      Left            =   0
      Picture         =   "frLABVender.frx":0000
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9345
   End
End
Attribute VB_Name = "frmLABVender"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Dim myVenderLAB_ As BWGTransportVendor
...
Dim selResult As Integer
    If myVenderLAB_.isChanged Then
        ...
        If selResult = vbYes Then
            cmdSave_Click
            If myVenderLAB_.isChanged Then Exit Sub
...
Private Sub cmdSave_Click()
    ...
    If myVenderLAB_.isChanged Then
        myVenderLAB_.Save
        txtVenderCode.Text = myVenderLAB_.VendorCode
    End If
    If myVenderLAB_.isChanged = False Then MsgBox "จัดเก็บข้อมูลเรียบร้อยแล้ว", vbInformation
End Sub
...
Private Sub Form_Load()
    ...
    Set myVenderLAB_ = Nothing
    Set myVenderLAB_ = New BWGTransportVendor
...
Public Sub SetDataVenderLAB(selCompany As BWGTransportVendor)
Dim x%, tmpCol As Collection
Dim tmpS As New BWGSearchManager
    Set myVenderLAB_ = Nothing
    Set myVenderLAB_ = selCompany
    If myVenderLAB_ Is Nothing Then Exit Sub
    With myVenderLAB_
        txtVenderCode.Text = myVenderLAB_.VendorCode
...
Dim selResult As Integer
    ...
    If myVenderLAB_.isChanged Then
        ...
        If selResult = vbYes Then
            cmdSave_Click
            If myVenderLAB_.isChanged Then Cancel = 1
        ElseIf selResult = vbCancel Then
            Cancel = 1
        End If
    End If
...
Private Sub txtAddr_Validate(Cancel As Boolean)
    If myVenderLAB_ Is Nothing Then
        CreateNewTransportVender
    End If
    myVenderLAB_.Addr = Trim(txtAddr.Text)
End Sub
...
Private Sub txtCompanyNameTH_Validate(Cancel As Boolean)
    If myVenderLAB_ Is Nothing Then
        CreateNewTransportVender
    End If
    myVenderLAB_.NameTH = Trim(txtCompanyNameTH.Text)
End Sub
...
Private Sub txtCompanyRem_Change()
    If myVenderLAB_ Is Nothing Then
        CreateNewTransportVender
    End If
    myVenderLAB_.SupplierRem = Trim(txtCompanyRem.Text)
End Sub
...
Private Sub txtEmail_Validate(Cancel As Boolean)
    ...
    myVenderLAB_.EmailAddr = Trim(txtEmail.Text)
End Sub
...
Private Sub txtFax_Validate(Cancel As Boolean)
    ...
    myVenderLAB_.FaxNo = Trim(txtFax.Text)
End Sub
...
Private Sub txtLicenseNo_Validate(Cancel As Boolean)
    ...
    myVenderLAB_.TransLicenseNo = Trim(txtLicenseNo.Text)
End Sub
...
Private Sub txtTaxID_Validate(Cancel As Boolean)
    ...
    myVenderLAB_.TaxID = Trim(txtTaxID.Text)
End Sub
...
Private Sub txtTelNo_Validate(Cancel As Boolean)
    ...
    myVenderLAB_.TelNo = Trim(txtTelNo.Text)
End Sub
...
Private Sub txtWebSite_Validate(Cancel As Boolean)
    ...
    myVenderLAB_.Website = Trim(txtWebsite.Text)
End Sub
    ...
    Else
        If Trim(curTumbol_.Name) <> Trim(txtTumbol.Text) Then
            ...
            With frmTumbolSearch
                ...
                .Show 1
            End With
            If myVenderLAB_.TumbolID = "" Then txtTumbol.Text = ""
        End If
    End If
End Sub
...
Public Sub SetDataTumbol(selTumbol As IMITumbol, Optional isAssigned As Boolean = True)
    ...
    With curTumbol_
        ...
        txtProvince.Text = .ProvinceName
        If isAssigned Then
            myVenderLAB_.AumphurID = .AumphurID
            myVenderLAB_.AumphurName = .AumphurName
            myVenderLAB_.TumbolID = .ID
            myVenderLAB_.TumbolName = .Name
            myVenderLAB_.ProvinceID = .ProvinceID
            myVenderLAB_.ProvinceName = .ProvinceName
        End If
    End With
End Sub
...
Private Sub txtZipCode_Validate(Cancel As Boolean)
    If myVenderLAB_ Is Nothing Then
        CreateNewTransportVender
    End If
    myVenderLAB_.ZipCode = Trim(txtZipCode.Text)
