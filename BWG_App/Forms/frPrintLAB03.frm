...
Begin VB.Form frmPrintLAB03 
   ...
   Begin VB.Label Label1 
      AutoSize        =   -1  'True
      BackStyle       =   0  'Transparent
      Caption         =   "พิมพ์รายงานจำนวน Waste ที่ส่งวิเคราะห์ (LAB03)"
      BeginProperty Font 
         Name            =   "Angsana New"
         Size            =   15.75
         Charset         =   222
   ...
   Begin VB.Image Image2 
      ...
      Index           =   1
      Left            =   0
      Picture         =   "frPrintLAB03.frx":0000
      Stretch         =   -1  'True
      Top             =   0
      Width           =   11280
   End
End
Attribute VB_Name = "frmPrintLAB03"
...
Dim tmpSql As String
    With rpt1
        ...
        .ReportFileName = App.Path & "\reports\LAB03.rpt"
        tmpSql = ""
        tmpSql = "SELECT * FROM vw_RptLAB01 " & vbCrLf
        ...
        If Not curCustomer_ Is Nothing Then
            ...
            End If
        End If
        tmpSql = tmpSql & vbCrLf & " ORDER BY SendBillNo,WasteName"
