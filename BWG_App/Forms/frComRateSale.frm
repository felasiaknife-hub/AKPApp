VERSION 5.00
Begin VB.Form frmComRateSale 
   BackColor       =   &H00FFFFFF&
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "อัตราค่าคอมมิชชั่นของเซลล์ - F019"
   ClientHeight    =   6555
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   6210
   ...
   End
End
Attribute VB_Name = "frmComRateSale"
...
Dim x%, tmpCom As BWGComRateSale
    Set colComRate_ = tmpS.ComRateSaleSearch
...
Dim tmpRate As BWGComRateSale
    With grComRate.getGridObj
        ...
        Else
            Set tmpRate = New BWGComRateSale
            tmpRate.ID = tmpID
