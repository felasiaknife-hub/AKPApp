...
Begin VB.Form frmPrintFIN04 
   ...
   Begin VB.Label Label1 
      BackStyle       =   0  'Transparent
      Caption         =   "รายงานจะแสดงเฉพาะรายการที่ระบุว่า ลูกค้ารับเช็คแล้วเท่านั้น"
      ForeColor       =   &H000000FF&
      Height          =   645
      Index           =   5
      Left            =   60
   ...
   Begin VB.Label Label1 
      AutoSize        =   -1  'True
      BackStyle       =   0  'Transparent
      Caption         =   "พิมพ์รายงานสรุปการรับเช็ค (FIN04)"
      BeginProperty Font 
         Name            =   "Angsana New"
         Size            =   15.75
         Charset         =   222
   ...
   Begin VB.Image Image2 
      ...
      Index           =   1
      Left            =   0
      Picture         =   "frPrintFIN04.frx":0000
      Stretch         =   -1  'True
      Top             =   0
      Width           =   11280
   End
End
Attribute VB_Name = "frmPrintFIN04"
...
Dim tmpSql As String
    With rpt1
        ...
        .ReportFileName = App.Path & "\reports\FIN04.rpt"
        tmpSql = ""
