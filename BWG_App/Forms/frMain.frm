...
Begin VB.MDIForm frmMain 
   ...
   Begin VB.Menu mnu_Rpt 
      ...
      Begin VB.Menu mnu_TransRpt 
         ...
         End
         Begin VB.Menu TRN18 
            Caption         =   "รายงานการขนใบงานที่ส่งแยกน้หนัก(TRN18)"
         End
      ...
      Begin VB.Menu mnu_RptAcc 
         ...
         End
         Begin VB.Menu Fin15B 
            Caption         =   "รายงานค่าบริการ (FIN15_B)"
         End
         Begin VB.Menu Fin16 
...
Private Sub Fin15B_Click()
 FrmPrintFIN15B.Show 1
End Sub
...
Private Sub TRN18_Click()
frmPrintTRN18.Show 1
End Sub
