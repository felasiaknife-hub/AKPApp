...
Begin VB.Form frmIncomeAKP 
   Caption         =   "รายได้ยอดขาย AP"
   ClientHeight    =   5055
   ClientLeft      =   60
   ClientTop       =   435
   ClientWidth     =   6165
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cboOper 
         Height          =   315
         ItemData        =   "frmIncomeAKP.frx":0000
         Left            =   3360
         List            =   "frmIncomeAKP.frx":0002
         Style           =   2  'Dropdown List
         TabIndex        =   4
         Top             =   1860
         Width           =   1305
      ...
      Begin VB.ComboBox CobJobtype 
         Height          =   315
         ItemData        =   "frmIncomeAKP.frx":0004
         Left            =   1140
         List            =   "frmIncomeAKP.frx":0011
         TabIndex        =   1
         Top             =   2640
         Width           =   1995
      End
   ...
   End
End
Attribute VB_Name = "frmIncomeAKP"
...
'        tmpSql = tmpSql & "From vw_MenifestSearch" & vbCrLf
        ...
        tmpSql = tmpSql & "WHERE ForYearMonth BETWEEN '" & dtFrom.YearValue & Format(dtFrom.MonthValue, "00") & "' AND '" & dtTo.YearValue & Format(dtTo.MonthValue, "00") & "'" & vbCrLf
           tmpSql = tmpSql & " AND ZoneName like 'BWG%' " & vbCrLf
