...
Dim subStr As String
    ...
    sqlStr = sqlStr & ", TripTransFee_Inc, VDTransFee, CloseStaff = (SELECT TOP(1) StaffFName + ' ' + StaffLName FROM tbCompanyStaff WHERE CloseStaffID = StaffID),TimetableNo" & vbCrLf
