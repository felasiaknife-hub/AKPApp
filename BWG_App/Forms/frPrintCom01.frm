...
Begin VB.Form frPrintComIn 
   ...
   Begin VB.Image Image2 
      ...
      Index           =   1
      Left            =   0
      Picture         =   "frPrintCom01.frx":0000
      Stretch         =   -1  'True
      Top             =   0
      Width           =   11280
   End
End
Attribute VB_Name = "frPrintComIn"
...
Dim tmpSql As String, iCount As Long
    tmpSql = ""
    tmpSql = "Select * from Com_vwComIn Where WorkDate >= '" & dtFrom.ValueYMD & "' And WorkDate<='" & dtTo.ValueYMD & "'"
