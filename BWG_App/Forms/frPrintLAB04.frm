...
Begin VB.Form frPrintLAB04 
   ...
   Begin VB.Label Label1 
      AutoSize        =   -1  'True
      BackStyle       =   0  'Transparent
      Caption         =   "พิมพ์รายงานการตรวจรับ Waste"
      BeginProperty Font 
         Name            =   "Angsana New"
         Size            =   15.75
         Charset         =   222
   ...
   Begin VB.Image Image2 
      ...
      Index           =   1
      Left            =   0
      Picture         =   "frPrintLAB04.frx":0000
      Stretch         =   -1  'True
      Top             =   0
      Width           =   11280
   End
End
Attribute VB_Name = "frPrintLAB04"
...
'                ' Me.CryReport.ParameterFields(4) = "dtDateReturn; " & varDate & ";Ture"
    ...
    Me.rpt1.ReportFileName = App.Path + "\Reports\LAB04.rpt"
