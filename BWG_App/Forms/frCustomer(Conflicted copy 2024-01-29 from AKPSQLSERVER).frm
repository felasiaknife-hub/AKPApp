...
Begin VB.Form frmCustomer 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(0).Control(0)=   "cbCRStaff"
      Tab(0).Control(1)=   "cbDept"
      Tab(0).Control(2)=   "TxtRefCode"
      Tab(0).Control(3)=   "cboDTeam"
      Tab(0).Control(4)=   "txtCountry"
      Tab(0).Control(5)=   "txtSale2"
      Tab(0).Control(6)=   "cmdDate"
      Tab(0).Control(7)=   "txtComment"
      Tab(0).Control(8)=   "txtSaleName"
      Tab(0).Control(9)=   "txtCustRemark"
      Tab(0).Control(10)=   "txtShortName"
      Tab(0).Control(11)=   "txtEmail"
      Tab(0).Control(12)=   "txtWebSite"
      Tab(0).Control(13)=   "txtZipCode"
      Tab(0).Control(14)=   "txtParentCust"
      Tab(0).Control(15)=   "cboCustType"
      Tab(0).Control(16)=   "lvWaste"
      Tab(0).Control(17)=   "txtFaxNo"
      Tab(0).Control(18)=   "txtTelNo"
      Tab(0).Control(19)=   "txtDepartment"
      Tab(0).Control(20)=   "txtContactName"
      Tab(0).Control(21)=   "txtFactoryID"
      Tab(0).Control(22)=   "cboDistrict"
      Tab(0).Control(23)=   "txtProvince"
      Tab(0).Control(23).Enabled=   0   'False
      Tab(0).Control(24)=   "txtAumphur"
      Tab(0).Control(24).Enabled=   0   'False
      Tab(0).Control(25)=   "txtTumbol"
      Tab(0).Control(26)=   "txtAddr"
      Tab(0).Control(27)=   "txtCompanyNameTH"
      Tab(0).Control(28)=   "txtIndustryType"
      Tab(0).Control(29)=   "txtGenID"
      Tab(0).Control(30)=   "Command1"
      Tab(0).Control(31)=   "cboCustGroup"
      Tab(0).Control(32)=   "Label2(57)"
      Tab(0).Control(33)=   "Label2(56)"
      Tab(0).Control(34)=   "Label2(55)"
      Tab(0).Control(35)=   "Label5(2)"
      Tab(0).Control(36)=   "Label2(36)"
      Tab(0).Control(37)=   "Label2(35)"
      Tab(0).Control(38)=   "lbDate"
      Tab(0).Control(39)=   "Label4"
      Tab(0).Control(40)=   "Label2(24)"
      Tab(0).Control(41)=   "Label2(27)"
      Tab(0).Control(42)=   "Label2(25)"
      Tab(0).Control(43)=   "Label2(23)"
      Tab(0).Control(44)=   "Label2(22)"
      Tab(0).Control(45)=   "Label2(21)"
      Tab(0).Control(46)=   "Label2(20)"
      Tab(0).Control(47)=   "Label2(14)"
      Tab(0).Control(48)=   "Label1(2)"
      Tab(0).Control(49)=   "Image1(1)"
      Tab(0).Control(50)=   "Label2(11)"
      Tab(0).Control(51)=   "Label2(10)"
      Tab(0).Control(52)=   "Label2(9)"
      Tab(0).Control(53)=   "Label2(8)"
      Tab(0).Control(54)=   "Label2(7)"
      Tab(0).Control(55)=   "Label2(6)"
      Tab(0).Control(56)=   "Label2(5)"
      Tab(0).Control(57)=   "Label2(4)"
      Tab(0).Control(58)=   "Label2(3)"
      Tab(0).Control(59)=   "Label2(2)"
      Tab(0).Control(60)=   "Label2(1)"
      Tab(0).Control(61)=   "Label2(0)"
      Tab(0).Control(62)=   "Label2(26)"
      Tab(0).Control(63)=   "Label2(12)"
      ...
      Tab(2).Control(0)=   "Label2(19)"
      Tab(2).Control(0).Enabled=   0   'False
      Tab(2).Control(1)=   "Label2(37)"
      Tab(2).Control(1).Enabled=   0   'False
      Tab(2).Control(2)=   "Label2(38)"
      Tab(2).Control(2).Enabled=   0   'False
      Tab(2).Control(3)=   "Label2(39)"
      Tab(2).Control(3).Enabled=   0   'False
      Tab(2).Control(4)=   "Label2(50)"
      Tab(2).Control(4).Enabled=   0   'False
      Tab(2).Control(5)=   "Label16"
      Tab(2).Control(5).Enabled=   0   'False
      Tab(2).Control(6)=   "Label17"
      Tab(2).Control(6).Enabled=   0   'False
      Tab(2).Control(7)=   "lvBillAddr"
      ...
      Tab(2).Control(13)=   "txtREAccContact"
      Tab(2).Control(13).Enabled=   0   'False
      Tab(2).Control(14)=   "txtREAccTel"
      Tab(2).Control(14).Enabled=   0   'False
      Tab(2).Control(15)=   "txtREAccFax"
      Tab(2).Control(15).Enabled=   0   'False
      Tab(2).Control(16)=   "txtCreditterm"
      Tab(2).Control(16).Enabled=   0   'False
      Tab(2).Control(17)=   "ChkBreak"
      Tab(2).Control(17).Enabled=   0   'False
      Tab(2).Control(18)=   "CbCredit"
