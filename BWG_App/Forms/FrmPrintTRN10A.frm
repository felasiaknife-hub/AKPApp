...
Begin VB.Form FrmPrintTRN10A 
   ...
   Begin VB.Image Image2 
      ...
      Index           =   1
      Left            =   0
      Picture         =   "FrmPrintTRN10A.frx":0000
      Stretch         =   -1  'True
      Top             =   0
      Width           =   11280
   End
End
Attribute VB_Name = "FrmPrintTRN10A"
...
Dim tmpSql As String
    With rpt1
        ...
        .ReportFileName = App.Path & "\reports\TRN10A.rpt"
        tmpSql = ""
        ...
        Else
            ...
            End If
        End If
        tmpSql = tmpSql & "ORDER BY WorkDate, CustomerName"
        ...
        .WindowTitle = "รายงานระยะทางการขนกาก (TRN10A)"
        .SQLQuery = tmpSql
