...
Begin VB.Form frmPrintTRN10 
   ...
   Begin VB.Image Image2 
      ...
      Index           =   1
      Left            =   0
      Picture         =   "frPrintTRN10.frx":0000
      Stretch         =   -1  'True
      Top             =   0
      Width           =   11280
   End
End
Attribute VB_Name = "frmPrintTRN10"
...
Private Sub Form_Load()
    ...
    End With
        CBOStat.Clear
        CBOStat.AddItem "==เลือกทุกสถานะ=="
        CBOStat.AddItem "ของแข็ง"
        CBOStat.AddItem "ของเหลว"
        CBOStat.AddItem "โคลน"
        CBOStat.AddItem "ไม่ระบุ"
        CBOStat.ListIndex = 0
    dtFrom.DayValue = 1
End Sub
...
Dim tmpSql As String
    ...
    End If
         ...
         If isEnv = True Then
        .ReportFileName = App.Path & "\reports\TRN101.rpt"
        Else
        .ReportFileName = App.Path & "\reports\TRN10.rpt"
        End If
        tmpSql = ""
        tmpSql = "SELECT * FROM vw_RptTRN10" & vbCrLf
        ...
        End If
        If Trim(txt) <> "" Then
            tmpSql = tmpSql & " and WasteCharacter='" & txt & "' " & vbCrLf
        End If
        tmpSql = tmpSql & "ORDER BY WorkDate, CustomerName,TruckTypeDesc"
        ...
        .WindowTitle = "รายงานการขนกากแยกตามประเภทเวสต์ (TRN10)"
        .SQLQuery = tmpSql
