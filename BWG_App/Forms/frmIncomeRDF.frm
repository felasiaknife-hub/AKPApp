...
Begin VB.Form frmIncomeRDF 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cboOper 
         Height          =   315
         ItemData        =   "frmIncomeRDF.frx":0000
         Left            =   3360
         List            =   "frmIncomeRDF.frx":0002
         Style           =   2  'Dropdown List
         TabIndex        =   8
         Top             =   1860
         Width           =   1305
      ...
      Begin VB.ComboBox CobJobtype 
         Height          =   315
         ItemData        =   "frmIncomeRDF.frx":0004
         Left            =   1140
         List            =   "frmIncomeRDF.frx":0011
         TabIndex        =   5
         Top             =   2640
         Width           =   1995
      End
   ...
   End
End
Attribute VB_Name = "frmIncomeRDF"
...
'            Else
                .ReportFileName = App.Path & "\reports\IncomesRDF.rpt"
'            End If
        End If
...
'        tmpSql = tmpSql & "From vw_MenifestSearch" & vbCrLf
        ...
        tmpSql = tmpSql & " AND (ZoneName like 'RDF%'  Or ZoneName = 'PST02')" & vbCrLf
