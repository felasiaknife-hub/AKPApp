...
Begin VB.Form frmPrintFIN07 
   ...
   Begin VB.Label Label1 
      AutoSize        =   -1  'True
      BackStyle       =   0  'Transparent
      Caption         =   "พิมพ์รายงานอายุลูกหนี้ (FIN07)"
      BeginProperty Font 
         Name            =   "Angsana New"
         Size            =   15.75
         Charset         =   222
   ...
   Begin VB.Image Image2 
      ...
      Index           =   1
      Left            =   0
      Picture         =   "frPrintFIN07.frx":0000
      Stretch         =   -1  'True
      Top             =   -30
      Width           =   11280
   End
End
Attribute VB_Name = "frmPrintFIN07"
...
Dim tmpSql As String, dateEng As String, custID As String, CompanyID As String
    ...
    Else
        ...
        End If
    End If
    DBConnExc "exec sp_RptFin07Generator '" & dtFrom.ValueYMD & "','" & dateEng & "','" & sessionID_ & "','" & CompanyID & "','" & custID & "'"
    Screen.MousePointer = 0
    With rpt1
        .LogonInfo(0) = "DSN = " & DSN_NAME & ";UID = " & strUid & ";PWD = " & strPwd
        .ReportFileName = App.Path & "\reports\FIN07.rpt"
        tmpSql = ""
        tmpSql = "SELECT * FROM vw_RptFIN07 " & vbCrLf
        tmpSql = tmpSql & "WHERE SessionID='" & sessionID_ & "' "
        tmpSql = tmpSql & vbCrLf & " ORDER BY CustomerName"
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
    DBConnExc "Delete tbRptFIN07 WHERE SessionID='" & sessionID_ & "'"
End Sub
