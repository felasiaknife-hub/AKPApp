...
Begin VB.Form frmMenifest 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(0).Control(24)=   "dtSign1"
      Tab(0).Control(24).Enabled=   0   'False
      Tab(0).Control(25)=   "dtWorkDate"
      Tab(0).Control(25).Enabled=   0   'False
      Tab(0).Control(26)=   "grItem"
      Tab(0).Control(26).Enabled=   0   'False
      Tab(0).Control(27)=   "txtCustomer"
      Tab(0).Control(27).Enabled=   0   'False
      Tab(0).Control(28)=   "txtCustTel"
      Tab(0).Control(28).Enabled=   0   'False
      Tab(0).Control(29)=   "txtCustFax"
      Tab(0).Control(29).Enabled=   0   'False
      Tab(0).Control(30)=   "txtSolidQty"
      Tab(0).Control(30).Enabled=   0   'False
      Tab(0).Control(31)=   "txtLiquidQty"
      Tab(0).Control(31).Enabled=   0   'False
      Tab(0).Control(32)=   "txtTreatment"
      Tab(0).Control(32).Enabled=   0   'False
      Tab(0).Control(33)=   "txtSigneName1"
      Tab(0).Control(33).Enabled=   0   'False
      Tab(0).Control(34)=   "txtCustER"
      Tab(0).Control(34).Enabled=   0   'False
      Tab(0).Control(35)=   "Frame4"
      Tab(0).Control(35).Enabled=   0   'False
      Tab(0).Control(36)=   "txtCollector"
      Tab(0).Control(36).Enabled=   0   'False
      Tab(0).Control(37)=   "txtCollectorID"
      Tab(0).Control(37).Enabled=   0   'False
      Tab(0).Control(38)=   "cboLiquidUnit"
      Tab(0).Control(38).Enabled=   0   'False
      Tab(0).Control(39)=   "cboSolidUnit"
      Tab(0).Control(39).Enabled=   0   'False
      Tab(0).Control(40)=   "cboSiteName"
      Tab(0).Control(40).Enabled=   0   'False
      Tab(0).Control(41)=   "cboWasteType"
      Tab(0).Control(41).Enabled=   0   'False
      Tab(0).Control(42)=   "cboGenerator"
      Tab(0).Control(42).Enabled=   0   'False
      Tab(0).Control(43)=   "txtCollectorID2"
      Tab(0).Control(43).Enabled=   0   'False
      Tab(0).Control(44)=   "txtCollector2"
      Tab(0).Control(44).Enabled=   0   'False
      Tab(0).Control(45)=   "txtJobNo"
      Tab(0).Control(45).Enabled=   0   'False
      Tab(0).Control(46)=   "cboWType"
      Tab(0).Control(46).Enabled=   0   'False
      Tab(0).Control(47)=   "txtPlace"
      Tab(0).Control(47).Enabled=   0   'False
      Tab(0).Control(48)=   "Command4"
      Tab(0).Control(48).Enabled=   0   'False
      Tab(0).Control(49)=   "cboRem"
      Tab(0).Control(49).Enabled=   0   'False
      Tab(0).Control(50)=   "txtRem"
      Tab(0).Control(50).Enabled=   0   'False
      Tab(0).Control(51)=   "txtLengthNum"
      ...
      Tab(1).Control(29)=   "Label2(90)"
      Tab(1).Control(30)=   "Label5"
      Tab(1).Control(31)=   "dtSign3"
      Tab(1).Control(32)=   "dtSign2"
      Tab(1).Control(33)=   "txtTrans1B"
      Tab(1).Control(34)=   "txtTransID1B"
      Tab(1).Control(35)=   "txtTransER"
      Tab(1).Control(35).Enabled=   0   'False
      Tab(1).Control(36)=   "txtTransFax"
      Tab(1).Control(36).Enabled=   0   'False
      Tab(1).Control(37)=   "txtTransTel"
      Tab(1).Control(37).Enabled=   0   'False
      Tab(1).Control(38)=   "txtFromProvince"
      Tab(1).Control(39)=   "txtToProvince"
      Tab(1).Control(40)=   "txtTransTime"
      Tab(1).Control(41)=   "txtSign1B"
      Tab(1).Control(42)=   "cboTransUnit"
      Tab(1).Control(43)=   "Frame1"
      Tab(1).Control(44)=   "txtDestName"
      Tab(1).Control(45)=   "cboTimeUnit"
      Tab(1).Control(46)=   "txtTreatTime"
      Tab(1).Control(46).Enabled=   0   'False
      Tab(1).Control(47)=   "txtDestTel"
      Tab(1).Control(47).Enabled=   0   'False
      Tab(1).Control(48)=   "txtDestFax"
      Tab(1).Control(48).Enabled=   0   'False
      Tab(1).Control(49)=   "txtDestER"
      Tab(1).Control(49).Enabled=   0   'False
      Tab(1).Control(50)=   "txtRealWeight"
      Tab(1).Control(51)=   "txtDestroyPlace"
      Tab(1).Control(52)=   "txtDestroyID"
      Tab(1).Control(53)=   "txtDestroyer"
      Tab(1).Control(54)=   "txtTumbol"
      Tab(1).Control(55)=   "txtAumphur"
      Tab(1).Control(55).Enabled=   0   'False
      Tab(1).Control(56)=   "txtTruckType"
      Tab(1).Control(57)=   "cboActualUnit"
      Tab(1).Control(58)=   "cboCarRegisID"
      Tab(1).Control(59)=   "txtDriverName"
      Tab(1).Control(60)=   "Check1"
      Tab(1).Control(61)=   "Frame5"
      Tab(1).Control(62)=   "TxtRate"
...
Dim compID As String
    ...
    With frmJobWasteDataAdd
        If cboGenerator.ListIndex = 0 Then
            .SetCallerForm Me, curCustomer_, "", compID, ""
        Else
            .SetCallerForm Me, curCustomer_, cboGenerator.Text, compID, ""
        End If
        .Show 1
