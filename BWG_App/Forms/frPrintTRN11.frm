...
Begin VB.Form frmPrintTRN11 
   ...
   Begin VB.Image Image2 
      ...
      Index           =   1
      Left            =   0
      Picture         =   "frPrintTRN11.frx":0000
      Stretch         =   -1  'True
      Top             =   0
      Width           =   11280
   End
End
Attribute VB_Name = "frmPrintTRN11"
...
Dim tmpSql As String
    With rpt1
        ...
        .ReportFileName = App.Path & "\reports\TRN11.rpt"
        tmpSql = ""
        tmpSql = "SELECT * FROM vw_RptTRN11" & vbCrLf
        ...
        .WindowTitle = "รายงานการขนกากที่มีการจ่ายค่าคอมฯ นอก (TRN11)"
        .SQLQuery = tmpSql
