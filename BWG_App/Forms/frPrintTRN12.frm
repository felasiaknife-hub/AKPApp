...
Begin VB.Form frmPrintTRN12 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CheckBox Check1 
         BackColor       =   &H00FFFFFF&
         Caption         =   "แสดงจำนวนเที่ยวตามลูกค้า"
         Height          =   255
         Left            =   1140
         TabIndex        =   7
         Top             =   2340
   ...
   Begin VB.Image Image2 
      ...
      Index           =   1
      Left            =   0
      Picture         =   "frPrintTRN12.frx":0000
      Stretch         =   -1  'True
      Top             =   0
      Width           =   11280
   End
End
Attribute VB_Name = "frmPrintTRN12"
...
Dim tmpSql As String
    With rpt1
        ...
        If isMD = False Then
            .ReportFileName = App.Path & "\reports\TRN12.rpt"
        Else
            .ReportFileName = App.Path & "\reports\TRN12_MD.rpt"
        End If
...
'        tmpSql = tmpSql & "AND SiteAumphurName = 'คลองหลวง')" & vbCrLf
        ...
        .WindowTitle = "รายงานการขนกากแยกตามประเภทรถ (TRN12)"
        If Check1.Value = 1 Then
            .WindowShowGroupTree = True
            .Formulas(2) = "ShowGroup=" & Chr(34) & "True" & Chr(34)
        Else
            .WindowShowGroupTree = False
            .Formulas(2) = "ShowGroup=" & Chr(34) & "Flase" & Chr(34)
        End If
