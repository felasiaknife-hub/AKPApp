...
Begin VB.Form frmWasteData 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(1).Control(6)=   "Label7(2)"
      Tab(1).Control(7)=   "Label7(3)"
      Tab(1).Control(8)=   "Label7(4)"
      Tab(1).Control(9)=   "Label7(5)"
      Tab(1).Control(10)=   "Label26"
      Tab(1).Control(11)=   "lbSameplingDate"
      Tab(1).Control(12)=   "cboStoreType"
      Tab(1).Control(13)=   "cboIndoor"
      Tab(1).Control(14)=   "chkBag"
      Tab(1).Control(15)=   "txtBag"
      Tab(1).Control(16)=   "chkDrum"
      Tab(1).Control(17)=   "txtDrumDesc"
      Tab(1).Control(18)=   "chkOther2"
      Tab(1).Control(19)=   "txtOther2"
      Tab(1).Control(20)=   "chkTank"
      Tab(1).Control(21)=   "chkYard"
      Tab(1).Control(22)=   "cboTreatmentType"
      Tab(1).Control(23)=   "txtPlasticBag"
      Tab(1).Control(24)=   "chkPlasticBag"
      Tab(1).Control(25)=   "txtPlasticDrum"
      Tab(1).Control(26)=   "chkPlasticDrum"
      Tab(1).Control(27)=   "txtPlasticGallon"
      Tab(1).Control(28)=   "chkPlasticGallon"
      Tab(1).Control(29)=   "txtPaperBox"
      Tab(1).Control(30)=   "chkPaperBox"
      Tab(1).Control(31)=   "txtBottle"
      Tab(1).Control(32)=   "chkBottle"
      Tab(1).Control(33)=   "CmdDateAnalysis"
      Tab(1).ControlCount=   34
      TabCaption(2)   =   "วิธีการกำจัด"
      TabPicture(2)   =   "frWasteData.frx":008A
      Tab(2).ControlEnabled=   0   'False
      Tab(2).Control(0)=   "lvNewTreatment"
      ...
      Tab(7).Control(0)=   "TxtCarOrther"
      Tab(7).Control(1)=   "TxtFactoryCar"
      Tab(7).Control(2)=   "ChkisOrtherCar"
      Tab(7).Control(3)=   "ChkisFactoryCar"
      Tab(7).Control(4)=   "ChkisTankcar"
      Tab(7).Control(5)=   "ChkisTrailerW"
      Tab(7).Control(6)=   "ChkisHuerta"
      Tab(7).Control(7)=   "ChkisRollOff"
      Tab(7).Control(8)=   "ChkisLugger"
      Tab(7).Control(9)=   "Chkispickup"
      Tab(7).Control(10)=   "ChkisTruckTen"
      Tab(7).ControlCount=   11
      TabCaption(8)   =   "หมายเหตุ"
      TabPicture(8)   =   "frWasteData.frx":0132
      Tab(8).ControlEnabled=   0   'False
      Tab(8).Control(0)=   "TxtCommentWaste"
      Tab(8).Control(1)=   "ChkCanEvap"
      Tab(8).ControlCount=   2
      TabCaption(9)   =   "Extraction Test"
      TabPicture(9)   =   "frWasteData.frx":014E
      Tab(9).ControlEnabled=   0   'False
      Tab(9).Control(0)=   "Label44"
      ...
      Begin VB.CheckBox ChkCanEvap 
         Caption         =   "ของเหลว ตกตะกอน/Evap ได้"
         Height          =   195
         Left            =   -74730
         TabIndex        =   219
         Top             =   450
