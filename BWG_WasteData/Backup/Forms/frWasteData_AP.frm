...
Begin VB.Form frWasteData_AP 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "frWasteData_AP.frx":0000
      ...
      TabPicture(1)   =   "frWasteData_AP.frx":001C
      ...
      TabPicture(2)   =   "frWasteData_AP.frx":0038
      Tab(2).ControlEnabled=   0   'False
      Tab(2).Control(0)=   "ctlDate1"
      Tab(2).Control(1)=   "grParameter"
      Tab(2).Control(2)=   "txtHeatValue"
      Tab(2).Control(3)=   "Label2(34)"
      Tab(2).Control(4)=   "Label2(33)"
      Tab(2).Control(5)=   "Label2(32)"
   ...
   End
End
Attribute VB_Name = "frWasteData_AP"
...
Private Sub grParameter_BeforeUpdateValue(newValue As String, row As Integer, col As Integer, Cancel As Boolean)
    If col = 0 Or col = 2 Or col = 3 Then Cancel = True
    If col = 1 Then
