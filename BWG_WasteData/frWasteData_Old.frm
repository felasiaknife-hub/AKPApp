...
Begin VB.Form frWasteData 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   $"frWasteData.frx":0000
   ClientHeight    =   8280
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   11280
   ...
   Begin VB.ComboBox cboLABRes 
      Height          =   315
      ItemData        =   "frWasteData.frx":0019
      Left            =   7050
      List            =   "frWasteData.frx":0023
   ...
   Begin VB.ComboBox cboSummary 
      Height          =   315
      ItemData        =   "frWasteData.frx":003C
      Left            =   8790
      List            =   "frWasteData.frx":0049
      Style           =   2  'Dropdown List
      TabIndex        =   62
      Top             =   6960
      Width           =   2385
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "frWasteData.frx":007A
      ...
      TabPicture(1)   =   "frWasteData.frx":0096
      ...
      Begin VB.ComboBox cboTreatmentType 
         Height          =   315
         ItemData        =   "frWasteData.frx":00B2
         Left            =   -66030
         List            =   "frWasteData.frx":00BC
         Style           =   2  'Dropdown List
         TabIndex        =   49
         Top             =   480
         Width           =   1995
      ...
      Begin VB.ComboBox cboIndoor 
         Height          =   315
         ItemData        =   "frWasteData.frx":00D2
         Left            =   -70440
         List            =   "frWasteData.frx":00DF
         Style           =   2  'Dropdown List
         TabIndex        =   48
         Top             =   480
         Width           =   2985
      ...
      Begin VB.ComboBox cboStoreType 
         Height          =   315
         ItemData        =   "frWasteData.frx":00F6
         Left            =   -74280
         List            =   "frWasteData.frx":0103
         Style           =   2  'Dropdown List
         TabIndex        =   47
         Top             =   480
         Width           =   2985
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.ComboBox cboToxic 
            Height          =   315
            ItemData        =   "frWasteData.frx":0135
            Left            =   2250
            List            =   "frWasteData.frx":013F
            Style           =   2  'Dropdown List
            TabIndex        =   38
            Top             =   1020
            Width           =   1875
         ...
         Begin VB.CheckBox chkExplode 
            ...
            Width           =   1095
         End
         Begin prjBWG.ctlGrid grKorOrNo 
            Height          =   1785
            Left            =   7980
            TabIndex        =   46
            Top             =   660
      ...
      Begin VB.ComboBox cboWasteCharDesc 
         Height          =   315
         ItemData        =   "frWasteData.frx":016C
         Left            =   2310
         List            =   "frWasteData.frx":0179
         Style           =   2  'Dropdown List
         TabIndex        =   27
         Top             =   450
         Width           =   1695
      ...
      Begin VB.ComboBox cboWasteChar 
         Height          =   315
         ItemData        =   "frWasteData.frx":0191
         Left            =   330
         List            =   "frWasteData.frx":01A1
         Style           =   2  'Dropdown List
         TabIndex        =   26
         Top             =   450
         Width           =   1905
   ...
   Begin VB.ComboBox cboWasteType 
      Height          =   315
      ItemData        =   "frWasteData.frx":0233
      Left            =   7320
      List            =   "frWasteData.frx":0235
      Style           =   2  'Dropdown List
      TabIndex        =   6
      Top             =   420
      Width           =   1005
