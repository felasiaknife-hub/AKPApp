...
Dim tmpStr As String, tmpVal As Boolean
    ...
    If isChanged Then
        ...
        If Trim(curTruckType_.ID) = "" Then
            ...
            tmpCon.Execute "Insert into tbTruckType (TruckTypeID,TruckTypeDesc,CanBeTrailer,isFactoryCar) Values ('" & Trim(curTruckType_.ID) & "','" & (txtShortName.Text) & "','" & TF_To_YN(tmpVal) & "','" & TF_To_YN(tmpVal2) & "')"
        ...
        Else
            tmpCon.Execute "Update tbTruckType Set TruckTypeDesc='" & Trim(txtShortName.Text) & "',CanBeTrailer='" & TF_To_YN(tmpVal) & "',isFactoryCar='" & TF_To_YN(tmpVal2) & "'  Where TruckTypeID='" & curTruckType_.ID & "'"
