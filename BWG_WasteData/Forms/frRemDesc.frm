...
Dim tmpStr As String
    ...
    If Trim(txtShortName.Text) <> Trim(curRemDesc_.RemDesc) Then
        ...
        If Trim(curRemDesc_.ID) = "" Then
            ...
            tmpCon.Execute "Insert into tbRemarkList (RemarkID,RemDesc) Values ('" & Trim(curRemDesc_.ID) & "','" & (txtShortName.Text) & "')"
        ...
        Else
            tmpCon.Execute "Update tbRemarkList Set RemDesc='" & Trim(txtShortName.Text) & "' Where RemarkID='" & curRemDesc_.ID & "'"
