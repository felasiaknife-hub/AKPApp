...
Begin VB.Form frmWasteData 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(0).Control(3)=   "chkOdour"
      Tab(0).Control(4)=   "txtOdour"
      Tab(0).Control(5)=   "chkColor"
      Tab(0).Control(6)=   "txtColor"
      Tab(0).Control(7)=   "txtQuoPrice"
      ...
      Tab(1).Control(3)=   "Label2(31)"
      Tab(1).Control(4)=   "Label26"
      Tab(1).Control(5)=   "lbSameplingDate"
      Tab(1).Control(6)=   "lblUnit"
      Tab(1).Control(7)=   "cboStoreType"
      Tab(1).Control(8)=   "cboIndoor"
      Tab(1).Control(9)=   "cboTreatmentType"
      Tab(1).Control(10)=   "CmdDateAnalysis"
      Tab(1).Control(11)=   "cboStorageType"
      Tab(1).Control(12)=   "txtStorageDesc"
      ...
      Tab(3).Control(0)=   "lblAttach(3)"
      Tab(3).Control(0).Enabled=   0   'False
      Tab(3).Control(1)=   "lblAttach(2)"
      Tab(3).Control(1).Enabled=   0   'False
      Tab(3).Control(2)=   "lblAttach(1)"
      ...
      Tab(3).Control(6)=   "lblAttach(0)"
      Tab(3).Control(6).Enabled=   0   'False
      Tab(3).Control(7)=   "Label5"
      Tab(3).Control(7).Enabled=   0   'False
      Tab(3).Control(8)=   "OpenDialog"
      Tab(3).Control(8).Enabled=   0   'False
      Tab(3).Control(9)=   "cmdAttach(3)"
      Tab(3).Control(9).Enabled=   0   'False
      Tab(3).Control(10)=   "cmdAttach(2)"
      Tab(3).Control(10).Enabled=   0   'False
      Tab(3).Control(11)=   "cmdAttach(1)"
      Tab(3).Control(11).Enabled=   0   'False
      Tab(3).Control(12)=   "cmdCls(3)"
      Tab(3).Control(12).Enabled=   0   'False
      Tab(3).Control(13)=   "cmdCls(2)"
      Tab(3).Control(13).Enabled=   0   'False
      Tab(3).Control(14)=   "cmdCls(1)"
      Tab(3).Control(14).Enabled=   0   'False
      Tab(3).Control(15)=   "cmdOpenFile(3)"
      Tab(3).Control(15).Enabled=   0   'False
      Tab(3).Control(16)=   "cmdOpenFile(2)"
      Tab(3).Control(16).Enabled=   0   'False
      Tab(3).Control(17)=   "cmdOpenFile(1)"
      Tab(3).Control(17).Enabled=   0   'False
      Tab(3).Control(18)=   "cmdOpenFile(0)"
      Tab(3).Control(18).Enabled=   0   'False
      Tab(3).Control(19)=   "cmdCls(0)"
      Tab(3).Control(19).Enabled=   0   'False
      Tab(3).Control(20)=   "cmdAttach(0)"
      Tab(3).Control(20).Enabled=   0   'False
      Tab(3).ControlCount=   21
      TabCaption(4)   =   "ผลการวิเคราะห์ AKP"
      TabPicture(4)   =   "frWasteData.frx":00C2
      Tab(4).ControlEnabled=   -1  'True
      Tab(4).Control(0)=   "lbAnalysisNo"
      Tab(4).Control(0).Enabled=   0   'False
      Tab(4).Control(1)=   "Label27"
      Tab(4).Control(1).Enabled=   0   'False
      Tab(4).Control(2)=   "Label49"
      Tab(4).Control(2).Enabled=   0   'False
      Tab(4).Control(3)=   "Label31"
      Tab(4).Control(3).Enabled=   0   'False
      Tab(4).Control(4)=   "Label14"
      Tab(4).Control(4).Enabled=   0   'False
      Tab(4).Control(5)=   "Label13"
      Tab(4).Control(5).Enabled=   0   'False
      Tab(4).Control(6)=   "Label12"
      Tab(4).Control(6).Enabled=   0   'False
      Tab(4).Control(7)=   "Label18(1)"
      Tab(4).Control(7).Enabled=   0   'False
      Tab(4).Control(8)=   "Label18(0)"
      Tab(4).Control(8).Enabled=   0   'False
      Tab(4).Control(9)=   "Label17(1)"
      Tab(4).Control(9).Enabled=   0   'False
      Tab(4).Control(10)=   "Label17(0)"
      Tab(4).Control(10).Enabled=   0   'False
      Tab(4).Control(11)=   "Label16(3)"
      Tab(4).Control(11).Enabled=   0   'False
      Tab(4).Control(12)=   "Label16(2)"
      Tab(4).Control(12).Enabled=   0   'False
      Tab(4).Control(13)=   "Label16(1)"
      Tab(4).Control(13).Enabled=   0   'False
      Tab(4).Control(14)=   "Label16(0)"
      Tab(4).Control(14).Enabled=   0   'False
      Tab(4).Control(15)=   "Label63"
      Tab(4).Control(15).Enabled=   0   'False
      Tab(4).Control(16)=   "Label46"
      Tab(4).Control(16).Enabled=   0   'False
      Tab(4).Control(17)=   "Label22"
      Tab(4).Control(17).Enabled=   0   'False
      Tab(4).Control(18)=   "Label21"
      Tab(4).Control(18).Enabled=   0   'False
      Tab(4).Control(19)=   "Label20"
      Tab(4).Control(19).Enabled=   0   'False
      Tab(4).Control(20)=   "Label19"
      Tab(4).Control(20).Enabled=   0   'False
      Tab(4).Control(21)=   "lbAnalysisDate"
      Tab(4).Control(21).Enabled=   0   'False
      Tab(4).Control(22)=   "Label29"
      Tab(4).Control(22).Enabled=   0   'False
      Tab(4).Control(23)=   "lbReceivedDate"
      Tab(4).Control(23).Enabled=   0   'False
      Tab(4).Control(24)=   "Label28"
      Tab(4).Control(24).Enabled=   0   'False
      Tab(4).Control(25)=   "Label25"
      Tab(4).Control(25).Enabled=   0   'False
      Tab(4).Control(26)=   "Label24"
      Tab(4).Control(26).Enabled=   0   'False
      Tab(4).Control(27)=   "Label38"
      Tab(4).Control(27).Enabled=   0   'False
      Tab(4).Control(28)=   "Label9"
      Tab(4).Control(28).Enabled=   0   'False
      Tab(4).Control(29)=   "Label34"
      Tab(4).Control(29).Enabled=   0   'False
      Tab(4).Control(30)=   "Label43"
      Tab(4).Control(30).Enabled=   0   'False
      Tab(4).Control(31)=   "Label42"
      Tab(4).Control(31).Enabled=   0   'False
      Tab(4).Control(32)=   "Label41"
      Tab(4).Control(32).Enabled=   0   'False
      Tab(4).Control(33)=   "Label40"
      Tab(4).Control(33).Enabled=   0   'False
      Tab(4).Control(34)=   "Label39"
      Tab(4).Control(34).Enabled=   0   'False
      Tab(4).Control(35)=   "Label23"
      Tab(4).Control(35).Enabled=   0   'False
      Tab(4).Control(36)=   "Label18(3)"
      Tab(4).Control(36).Enabled=   0   'False
      Tab(4).Control(37)=   "Label18(4)"
      Tab(4).Control(37).Enabled=   0   'False
      Tab(4).Control(38)=   "Frame7"
      Tab(4).Control(38).Enabled=   0   'False
      Tab(4).Control(39)=   "Frame6"
      Tab(4).Control(39).Enabled=   0   'False
      Tab(4).Control(40)=   "Frame5"
      Tab(4).Control(40).Enabled=   0   'False
      Tab(4).Control(41)=   "CbSamplingBy"
      Tab(4).Control(41).Enabled=   0   'False
      Tab(4).Control(42)=   "txtNCVValue"
      Tab(4).Control(42).Enabled=   0   'False
      Tab(4).Control(43)=   "txtPhysicalstate"
      Tab(4).Control(43).Enabled=   0   'False
      Tab(4).Control(44)=   "txtHeatingValue"
      Tab(4).Control(44).Enabled=   0   'False
      Tab(4).Control(45)=   "txtBulkdensity"
      Tab(4).Control(45).Enabled=   0   'False
      Tab(4).Control(46)=   "txtviscosity"
      Tab(4).Control(46).Enabled=   0   'False
      Tab(4).Control(47)=   "txtsolidcontent"
      Tab(4).Control(47).Enabled=   0   'False
      Tab(4).Control(48)=   "txtSludgecontent"
      Tab(4).Control(48).Enabled=   0   'False
      Tab(4).Control(49)=   "txtS"
      Tab(4).Control(49).Enabled=   0   'False
      Tab(4).Control(50)=   "textF"
      Tab(4).Control(50).Enabled=   0   'False
      Tab(4).Control(51)=   "txtCL"
      Tab(4).Control(51).Enabled=   0   'False
      Tab(4).Control(52)=   "txtAshcontent"
      Tab(4).Control(52).Enabled=   0   'False
      Tab(4).Control(53)=   "txtWatercontent"
      Tab(4).Control(53).Enabled=   0   'False
      Tab(4).Control(54)=   "txtmoisturecontent"
      Tab(4).Control(54).Enabled=   0   'False
      Tab(4).Control(55)=   "TxtSS"
      Tab(4).Control(55).Enabled=   0   'False
      Tab(4).Control(56)=   "TxtAcidity"
      Tab(4).Control(56).Enabled=   0   'False
      Tab(4).Control(57)=   "txtHg"
      Tab(4).Control(57).Enabled=   0   'False
      Tab(4).Control(58)=   "txtCr"
      Tab(4).Control(58).Enabled=   0   'False
      Tab(4).Control(59)=   "txtCd"
      Tab(4).Control(59).Enabled=   0   'False
      Tab(4).Control(60)=   "txtAs"
      Tab(4).Control(60).Enabled=   0   'False
      Tab(4).Control(61)=   "Command4"
      Tab(4).Control(61).Enabled=   0   'False
      Tab(4).Control(62)=   "Command2"
      Tab(4).Control(62).Enabled=   0   'False
      Tab(4).Control(63)=   "cboAnalysis"
      Tab(4).Control(63).Enabled=   0   'False
      Tab(4).Control(64)=   "txtAcomment"
      Tab(4).Control(64).Enabled=   0   'False
      Tab(4).Control(65)=   "TxtAlkalinity"
      Tab(4).Control(65).Enabled=   0   'False
      Tab(4).Control(66)=   "TxtHeavyFe"
      Tab(4).Control(66).Enabled=   0   'False
      Tab(4).Control(67)=   "TxtConcentrate"
      Tab(4).Control(67).Enabled=   0   'False
      Tab(4).Control(68)=   "txtCut"
      Tab(4).Control(68).Enabled=   0   'False
      Tab(4).Control(69)=   "txtZn"
      Tab(4).Control(69).Enabled=   0   'False
      Tab(4).Control(70)=   "txtMn"
      Tab(4).Control(70).Enabled=   0   'False
      Tab(4).Control(71)=   "txtNi"
      Tab(4).Control(71).Enabled=   0   'False
      Tab(4).Control(72)=   "txtCu"
      Tab(4).Control(72).Enabled=   0   'False
      Tab(4).Control(73)=   "txtPb"
      Tab(4).Control(73).Enabled=   0   'False
      Tab(4).Control(74)=   "txtNitrogenContent"
      Tab(4).Control(74).Enabled=   0   'False
      Tab(4).Control(75)=   "txtDrybasisContent"
      Tab(4).Control(75).Enabled=   0   'False
      Tab(4).ControlCount=   76
      TabCaption(5)   =   "การจัดการ"
      TabPicture(5)   =   "frWasteData.frx":00DE
      Tab(5).ControlEnabled=   0   'False
      Tab(5).Control(0)=   "ChkCanEvap"
      Tab(5).Control(1)=   "chkPrecipitation"
      Tab(5).Control(2)=   "chkNeutralization"
      Tab(5).Control(3)=   "txtDirectEvapDesc"
      Tab(5).Control(4)=   "txtPrecipitationDesc"
      Tab(5).Control(5)=   "txtNeutralizationDesc"
      Tab(5).Control(6)=   "chkComment"
      Tab(5).Control(7)=   "TxtCommentWaste"
      Tab(5).ControlCount=   8
      TabCaption(6)   =   "ประเภทรถ"
      TabPicture(6)   =   "frWasteData.frx":00FA
      Tab(6).ControlEnabled=   0   'False
      Tab(6).Control(0)=   "ChkisTruckTen"
      Tab(6).Control(1)=   "Chkispickup"
      Tab(6).Control(2)=   "ChkisLugger"
      Tab(6).Control(3)=   "ChkisRollOff"
      Tab(6).Control(4)=   "ChkisHuerta"
      Tab(6).Control(5)=   "ChkisTrailerW"
      Tab(6).Control(6)=   "ChkisTankcar"
      Tab(6).Control(7)=   "ChkisFactoryCar"
      Tab(6).Control(8)=   "ChkisOrtherCar"
      Tab(6).Control(9)=   "TxtFactoryCar"
      Tab(6).Control(10)=   "TxtCarOrther"
      Tab(6).ControlCount=   11
      TabCaption(7)   =   "Extraction Test"
      TabPicture(7)   =   "frWasteData.frx":0116
      Tab(7).ControlEnabled=   0   'False
      Tab(7).Control(0)=   "TxtLabcode"
      Tab(7).Control(1)=   "Frame9"
      Tab(7).Control(2)=   "Label44"
      Tab(7).ControlCount=   3
      TabCaption(8)   =   "ผล X-Ray"
      TabPicture(8)   =   "frWasteData.frx":0132
      Tab(8).ControlEnabled=   0   'False
      Tab(8).Control(0)=   "Label51"
      Tab(8).Control(1)=   "Frame10"
      Tab(8).Control(2)=   "Text1(0)"
      Tab(8).ControlCount=   3
      TabCaption(9)   =   "หมายเหตุ"
      TabPicture(9)   =   "frWasteData.frx":014E
      Tab(9).ControlEnabled=   0   'False
      Tab(9).Control(0)=   "txtRemark"
      Tab(9).Control(1)=   "chkRemark"
      Tab(9).ControlCount=   2
      Begin VB.TextBox txtDrybasisContent 
         Appearance      =   0  'Flat
         BackColor       =   &H00C0FFC0&
         Height          =   300
         Left            =   3900
         ...
         Width           =   1700
      End
      Begin VB.TextBox txtNitrogenContent 
         Appearance      =   0  'Flat
         BackColor       =   &H00C0FFC0&
         Height          =   300
         Left            =   3900
      ...
      Begin VB.CheckBox chkComment 
         ...
         Width           =   1665
      End
      Begin VB.TextBox txtNeutralizationDesc 
         Appearance      =   0  'Flat
         BackColor       =   &H00FFFFFF&
         ForeColor       =   &H00000080&
         Height          =   570
         ...
         Width           =   10770
      End
      Begin VB.TextBox txtPrecipitationDesc 
         Appearance      =   0  'Flat
         BackColor       =   &H00FFFFFF&
         ForeColor       =   &H00000080&
         Height          =   570
         ...
         Width           =   10770
      End
      Begin VB.TextBox txtDirectEvapDesc 
         Appearance      =   0  'Flat
         BackColor       =   &H00FFFFFF&
         ForeColor       =   &H00000080&
         Height          =   570
         ...
         Width           =   10770
      End
      Begin VB.CheckBox chkNeutralization 
         Caption         =   "ปรับสภาพ"
         Height          =   195
         Left            =   -74520
         TabIndex        =   288
      ...
      Begin VB.ComboBox cboAnalysis 
         ...
         ForeColor       =   &H00400000&
         Height          =   315
         ItemData        =   "frWasteData.frx":0340
         Left            =   8400
         List            =   "frWasteData.frx":0342
         TabIndex        =   205
         Text            =   "cboAnalysis"
         Top             =   3585
         Width           =   3000
      ...
      Begin VB.Frame Frame7 
         ...
         End
      End
      Begin VB.TextBox txtStorageDesc 
         Appearance      =   0  'Flat
         Height          =   315
         Left            =   -70920
         MaxLength       =   100
         ...
         Width           =   6180
      End
      Begin VB.ComboBox cboStorageType 
         BackColor       =   &H0080C0FF&
         Height          =   315
         ItemData        =   "frWasteData.frx":0344
         Left            =   -74280
         List            =   "frWasteData.frx":0346
         Style           =   2  'Dropdown List
         TabIndex        =   154
         Top             =   1305
         Width           =   3015
      ...
      Begin VB.ComboBox cboTreatmentType 
         BackColor       =   &H00C0FFC0&
         Height          =   315
         ItemData        =   "frWasteData.frx":0348
         Left            =   -66000
         List            =   "frWasteData.frx":0352
         Style           =   2  'Dropdown List
         TabIndex        =   107
         Top             =   825
         Visible         =   0   'False
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.ComboBox cboToxic 
            BackColor       =   &H00FFFFC0&
            Height          =   315
            ItemData        =   "frWasteData.frx":036C
            Left            =   2280
            List            =   "frWasteData.frx":0376
            Style           =   2  'Dropdown List
            TabIndex        =   88
            Top             =   960
            Width           =   1875
      ...
      Begin VB.ComboBox cboWasteCharDesc 
         BackColor       =   &H00C0E0FF&
         Height          =   315
         ItemData        =   "frWasteData.frx":03A3
         Left            =   -72720
         List            =   "frWasteData.frx":03A5
         Style           =   2  'Dropdown List
         TabIndex        =   79
         Top             =   870
         Width           =   1695
...
Private Sub cboStorageType_Click()
 If cboStorageType.ListIndex = 1 Or cboStorageType.ListIndex = 7 Then
       lblUnit.Caption = "กก."
    ElseIf cboStorageType.ListIndex = 3 Or cboStorageType.ListIndex = 5 Or cboStorageType.ListIndex = 6 Or cboStorageType.ListIndex = 8 Then
       lblUnit.Caption = "ลิตร"
    Else
    lblUnit.Caption = ""
    End If
End Sub

Private Sub cboStorageType_Validate(Cancel As Boolean)
    Select Case cboStorageType.ListIndex
            Case 1 'ถุงขนาดใหญ่
               myWasteDataLab_.StorageType = "BA"
               myWasteDataLab_.StorageDesc = txtStorageDesc.Text
               
            Case 2
                 myWasteDataLab_.StorageType = "ST"
            Case 3
                 myWasteDataLab_.StorageType = "DR"
                  myWasteDataLab_.StorageDesc = txtStorageDesc.Text
            Case 4
                 myWasteDataLab_.StorageType = "TA"
            Case 5
                 myWasteDataLab_.StorageType = "PG"
                  myWasteDataLab_.isPlasticGallon = True
                  myWasteDataLab_.PlasticGallon = txtStorageDesc.Text
            Case 6
                 myWasteDataLab_.StorageType = "BT"
                 myWasteDataLab_.isBottle = True
                  myWasteDataLab_.Bottle = txtStorageDesc.Text
            Case 7
                  myWasteDataLab_.StorageType = "PT"
                  myWasteDataLab_.isPlasticBag = True
                  myWasteDataLab_.PlasticBag = txtStorageDesc.Text
             Case 8
                 myWasteDataLab_.StorageType = "PD"
                 myWasteDataLab_.isPlasticDrum = True
                  myWasteDataLab_.PlasticDrum = txtStorageDesc.Text
            Case 9
                 myWasteDataLab_.StorageType = "PB"
                 myWasteDataLab_.isPaperBox = True
                myWasteDataLab_.PaperBox = txtStorageDesc.Text
            Case 10
                 myWasteDataLab_.StorageType = "OT"
                  myWasteDataLab_.StorageDesc = txtStorageDesc.Text
        End Select
        myWasteDataLab_.isChanged = True
End Sub
...
Private Sub CbSamplingBy_Validate(Cancel As Boolean)
 On Error Resume Next
  ...
  Select Case CbSamplingBy.ListIndex
    ...
    Case 1
        myWasteDataLab_.SamplingByNo = "ว-217-จ-0006"
    Case 2
...
If ChkCanEvap.Value = 1 Then
    myWasteDataCR_.CanEvap = True
    Else
     myWasteDataCR_.CanEvap = False
End If
End Sub
...
Private Sub chkComment_Validate(Cancel As Boolean)
Dim i As Integer
    If chkComment.Value = 1 Then
        myWasteDataCR_.CommentWaste = True
        Else
         myWasteDataCR_.CommentWaste = False
    End If
End Sub
...
Private Sub chkNeutralization_Validate(Cancel As Boolean)
If chkNeutralization.Value = 1 Then
    myWasteDataCR_.Neutralization = True
    Else
      myWasteDataCR_.Neutralization = False
End If
End Sub
...
Private Sub chkPrecipitation_Validate(Cancel As Boolean)
    If chkPrecipitation.Value = 1 Then
    myWasteDataCR_.Precipitation = True
    Else
      myWasteDataCR_.Precipitation = False
End If
End Sub
...
Private Sub chkRemark_Validate(Cancel As Boolean)
    If chkRemark.Value = 1 Then
    myWasteDataCR_.Remark = True
    Else
      myWasteDataCR_.Remark = False
End If
End Sub
            ...
            If cboWasteChar.ListIndex >= 1 And cboWasteChar.ListIndex <= 2 Then
              ...
              End If
                ...
                If cboIndoor.ListIndex = 0 Then
                    ...
                    Exit Sub
                End If
                If cboStorageType.ListIndex = 0 Then
                    ...
                    Exit Sub
                End If
             If cboStorageType.ListIndex = 1 Then
                If Trim(txtStorageDesc.Text) = "" Or Trim(txtStorageDesc.Text) = 0 Then
                ...
                End If
            End If
          If cboStorageType.ListIndex = 3 Then
                If Trim(txtStorageDesc.Text) = "" And Trim(txtStorageDesc.Text) = 0 Then
                ...
                End If
            End If
            If cboStorageType.ListIndex = 5 Then
                If Trim(txtStorageDesc.Text) = "" And Trim(txtStorageDesc.Text) = 0 Then
                    MsgBox "ระบุขนาดจัดเก็บ แกนลอนพลาสติก : Plastic Gallon  และขนาด มากกว่า 0 ", vbExclamation
                    cmdApprove.Visible = True
                    cmdSave.Enabled = False
                ...
                End If
            End If
              If cboStorageType.ListIndex = 6 Then
                If Trim(txtStorageDesc.Text) = "" Or Trim(txtStorageDesc.Text) = 0 Then
                ...
                End If
            End If
              If cboStorageType.ListIndex = 7 Then
                If Trim(txtStorageDesc.Text) = "" Or Trim(txtStorageDesc.Text) = 0 Then
                ...
                End If
            End If
            If cboStorageType.ListIndex = 8 Then
                If Trim(txtStorageDesc.Text) = "" Or Trim(txtStorageDesc.Text) = 0 Then
                ...
                End If
            End If
           If cboStorageType.ListIndex = 9 Then
                If Trim(txtStorageDesc.Text) = "" Or Trim(txtStorageDesc.Text) = 0 Then
...
Private Sub CmdSave_Click()
    ...
    '            End If
                ...
                End If
        End If
        If Len(txtDirectEvapDesc.Text) > 300 Then
            MsgBox "Evap โดยตรงมีอักขระเกิน 300 ตัวอักษร", vbExclamation
            Exit Sub
        End If
         If Len(txtPrecipitationDesc.Text) > 300 Then
            MsgBox "ตกตะกอน มีอักขระเกิน 300 ตัวอักษร", vbExclamation
            Exit Sub
        End If
         If Len(txtNeutralizationDesc.Text) > 300 Then
            MsgBox "ปรับสภาพ มีอักขระเกิน 300 ตัวอักษร", vbExclamation
            Exit Sub
        End If
         If Len(txtDirectEvapDesc.Text) > 300 Then
            MsgBox "Comment มีอักขระเกิน 300 ตัวอักษร", vbExclamation
            Exit Sub
        End If
        If isEnv = True Then
...
''                        End If
    ...
    '    myWasteDataCR_.companyID = "776EDA5830F744A6B3551348D851BC22"
        myWasteDataCR_.CommentWasteDesc = TxtCommentWaste.Text
...
'    End With
    ...
    With cboStorageType
        .Clear
        .AddItem ""
        .AddItem "ถุงขนาดใหญ่ :  Big Bag "
        .AddItem "ลานกอง : Stock Yard"
        .AddItem "ถังเหล็ก : Metal Drum"
        .AddItem "บ่อรวบรวม : Collecting Tank"
        .AddItem "แกนลอนพสาสติก : Plastic Gallon"
        .AddItem "ขวดแก้ว : Bottle"
        .AddItem "ถุงพลาสติก : Plastic Bag"
        .AddItem "ถังพลาสติก : Plastic Drum"
        .AddItem "กล่องกระดาษ"
        .AddItem "อื่นๆ"
    End With
...
Private Sub TxtCommentWaste_Change()
    myWasteDataCR_.CommentWasteDesc = Trim(TxtCommentWaste.Text)
    myWasteDataCR_.isChanged = True
End Sub
...
Private Sub txtDirectEvapDesc_Validate(Cancel As Boolean)
    myWasteDataCR_.EvapDesc = txtDirectEvapDesc.Text
    myWasteDataCR_.isChanged = True
End Sub

Private Sub txtDrybasisContent_Change()
    myWasteDataLab_.DrybasisContent = Trim(txtDrybasisContent.Text)
    myWasteDataLab_.isChanged = True
End Sub
...
Private Sub txtNeutralizationDesc_Validate(Cancel As Boolean)
    myWasteDataCR_.NeutralizationDesc = txtNeutralizationDesc.Text
    myWasteDataCR_.isChanged = True
End Sub
...
Private Sub txtNitrogenContent_Change()
    myWasteDataLab_.NitrogenContent = Trim(txtNitrogenContent.Text)
    myWasteDataLab_.isChanged = True
End Sub
...
Private Sub txtPrecipitationDesc_Validate(Cancel As Boolean)
    myWasteDataCR_.PrecipitationDesc = txtPrecipitationDesc.Text
    myWasteDataCR_.isChanged = True
End Sub
...
Private Sub txtRemark_Validate(Cancel As Boolean)
    myWasteDataCR_.RemarkDesc = txtRemark.Text
    myWasteDataCR_.isChanged = True
End Sub
...
Private Sub txtStorageDesc_Validate(Cancel As Boolean)
    myWasteDataLab_.StorageDesc = Trim(txtStorageDesc.Text)
End Sub
...
'            Txt14Digit.Text = .Digit14
            ...
            If .Precipitation Then
                chkPrecipitation.Value = 1
            Else
                chkPrecipitation.Value = 0
            End If
            If .Neutralization Then
                chkNeutralization.Value = 1
            Else
                chkNeutralization.Value = 0
            End If
            If .CommentWaste Then
                chkComment.Value = 1
            Else
                 chkComment.Value = 0
            End If
            ...
            txtDirectEvapDesc.Text = .EvapDesc
            txtPrecipitationDesc.Text = .PrecipitationDesc
            txtNeutralizationDesc.Text = .NeutralizationDesc
            TxtCommentWaste.Text = .CommentWasteDesc
            txtRemark.Text = .RemarkDesc
...
'                        cmdRev.Visible = True
    ...
    With myWasteDataLab_
        ...
        Select Case .StorageType
            Case "BA" 'ถุงขนาดใหญ่
               cboStorageType.ListIndex = 1
               txtStorageDesc.Text = .StorageDesc
            Case "ST"
                cboStorageType.ListIndex = 2
                txtStorageDesc.Text = .StorageDesc
            Case "DR"
                 cboStorageType.ListIndex = 3
                 txtStorageDesc.Text = .StorageDesc
            Case "OT"
               cboStorageType.ListIndex = 10
               txtStorageDesc.Text = .StorageDesc
            Case "TA"
              cboStorageType.ListIndex = 4
            Case "PG"
                cboStorageType.ListIndex = 5
                txtStorageDesc.Text = .PlasticGallon
            Case "BT"
               cboStorageType.ListIndex = 6
                txtStorageDesc.Text = .Bottle
             Case "PT"
                 cboStorageType.ListIndex = 7
                  txtStorageDesc.Text = .PlasticBag
            Case "PD"
              cboStorageType.ListIndex = 8
               txtStorageDesc.Text = .PlasticDrum
            Case "PB"
                 cboStorageType.ListIndex = 9
                  txtStorageDesc.Text = .PaperBox
        End Select
         If cboStorageType.ListIndex = 1 Or cboStorageType.ListIndex = 7 Then
           lblUnit.Caption = "กก."
        ElseIf cboStorageType.ListIndex = 3 Or cboStorageType.ListIndex = 5 Or cboStorageType.ListIndex = 6 Or cboStorageType.ListIndex = 8 Then
...
'        Next
        ...
        txtNitrogenContent.Text = Trim(.NitrogenContent)
        txtDrybasisContent.Text = Trim(.DrybasisContent)
...
'        ptNitriteN.Enabled = False
        ...
        txtNitrogenContent.Enabled = False
        txtDrybasisContent.Enabled = False
