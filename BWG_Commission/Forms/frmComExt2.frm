...
Begin VB.Form frmComExt2 
   ...
   Begin VB.Label Label1 
      AutoSize        =   -1  'True
      BackStyle       =   0  'Transparent
      Caption         =   "รายงานการรับชำระค่าบริการ / ค่าคอมฯ ภายนอก"
      BeginProperty Font 
         Name            =   "Angsana New"
         Size            =   15.75
         Charset         =   222
   ...
   Begin VB.Image Image2 
      ...
      Index           =   1
      Left            =   0
      Picture         =   "frmComExt2.frx":0000
      Stretch         =   -1  'True
      Top             =   0
      Width           =   11280
   End
End
Attribute VB_Name = "frmComExt2"
...
Dim tmpSql As String, iCount As Long
    tmpSql = ""
    tmpSql = "Select * from Com_vwComEx2_Union Where REDate >= '" & dtFrom.ValueYMD & "' And REDate <='" & dtTo.ValueYMD & "'"
