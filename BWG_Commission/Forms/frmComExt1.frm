...
Begin VB.Form frmComExt1 
   ...
   Begin VB.Image Image2 
      ...
      Index           =   1
      Left            =   0
      Picture         =   "frmComExt1.frx":0000
      Stretch         =   -1  'True
      Top             =   0
      Width           =   11280
   End
End
Attribute VB_Name = "frmComExt1"
...
Dim tmpSql As String, iCount As Long
    tmpSql = ""
    tmpSql = "Select * from Com_vwComEx_Union" & vbCrLf
    ...
    With rpt1
        ...
        tmpSql = tmpSql & "Order By ZoneName,StaffFName,StaffLName, CompanyName, WasteType"
