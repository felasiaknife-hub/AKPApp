...
Begin VB.Form frPrintCR03Search 
   BackColor       =   &H00FFFFFF&
   Caption         =   " "
   ClientHeight    =   6735
   ClientLeft      =   60
   ...
   Begin VB.Label Label2 
      AutoSize        =   -1  'True
      BackStyle       =   0  'Transparent
      Caption         =   "เลขที่ใบแจ้ง, ชื่อ-รหัสบริษัทที่ออกใบแจ้ง"
      ForeColor       =   &H000000FF&
      Height          =   195
      Index           =   2
      Left            =   2130
   ...
   End
End
Attribute VB_Name = "frPrintCR03Search"
...
Dim tmpItem As BWGPrintCR03
    ...
    strCond = "(CR03No Like '%" & criStr & "%' Or CompanyNameTH Like '%" & criStr & "%' Or CompanyCode Like '%" & criStr & "%')"
