...
Private Sub Image2_MouseDown(Button As Integer, Shift As Integer, x As Single, y As Single)
    If Button = 2 Then
        PopupMenu frMain.mnu_PopUser, , x + Image2.Left, y + Image2.Top
    End If
End Sub

Private Sub Label1_MouseDown(Button As Integer, Shift As Integer, x As Single, y As Single)
    If Button = 2 Then
        PopupMenu frMain.mnu_PopUser, , x + Label1.Left, y + Label1.Top
    End If
End Sub
...
Private Sub lvResult_MouseDown(Button As Integer, Shift As Integer, x As Single, y As Single)
    If Button = 2 Then
        PopupMenu frMain.mnu_PopUser, , x + lvResult.Left, y + lvResult.Top
    End If
End Sub
