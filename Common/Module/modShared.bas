...
Dim x%
    ...
    End If
End Sub
Public Sub PopulateReception()
On Error Resume Next
Dim tmpS As New BWGSearchManager
    Set colReception_ = tmpS.ReceptionSearch
    Set tmpS = Nothing
End Sub
Public Sub PopulateCancelRemark()
On Error Resume Next
Dim tmpS As New BWGSearchManager
    Set colCancelRemark_ = tmpS.CancelRemarkSearch
    Set tmpS = Nothing
End Sub
Public Sub PopulateRem(ByRef cbo As Object)
Dim x%, tmpS As New BWGSearchManager
    cbo.Clear
    cbo.AddItem "-เลือก-"
    ...
    End If
End Sub
Public Sub PopulateStaffInfo(ByRef cbo As Object)
Dim x%, tmpS As New BWGSearchManager
    cbo.Clear
    cbo.AddItem ""
    ...
    End If
End Sub
Public Sub PopulateBankAccInfo(ByRef cbo As Object, Optional strCon As String)
Dim x%, tmpS As New BWGSearchManager
    cbo.Clear
    cbo.AddItem ""
